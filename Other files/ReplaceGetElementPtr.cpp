//===- RepleceGetElementPtr.cpp - LegUp may use this pass after linking ----------------===//
//
...
namespace legup {
struct RepleceGetElementPtr : public FunctionPass {
  static char ID; // Pass identification, replacement for typeid
  RepleceGetElementPtr() : FunctionPass(ID) {};
...
/// replaceInst - Given an UDiv expressing a divide by constant,
/// replace it by multiplying by a magic number.  See:
/// <http://the.wall.riscom.net/books/proc/ppc/cwg/code2.html>
bool replaceInst(Instruction *inst) const {
  ConstantInt *Op1 = dyn_cast<ConstantInt>(inst->getOperand(1));
...
char RepleceGetElementPtr::ID = 0;
static RegisterPass<RepleceGetElementPtr> X("legup-repleceGetElementPtr",
  "this pass replaces GetElementPtr instructions with add, mul and sub instructions");
