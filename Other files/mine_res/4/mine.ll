...
define i32 @main() #0 {
  ...
  %9 = mul nsw i32 %8, %3
  %10 = sub nsw i32 %7, %9
  %11 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %10) #2
  %12 = icmp eq i32 %10, 30
  br i1 %12, label %13, label %15

; <label>:13                                      ; preds = %0
  %14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2
  br label %17

; <label>:15                                      ; preds = %0
  %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2
  br label %17
