...
reg  lpm_mult_main_0_5_en;
reg [31:0] main_0_5_stage0_reg;
...
always @(*) begin
	main_0_5 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %0*/
	/*   %6 = add nsw i32 %4, %5*/
...
always @(*) begin
	lpm_mult_main_0_5_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %5 = mul nsw i32 %1, %2*/
	if ((lpm_mult_main_0_5_en == 1'd1)) begin
		main_0_5_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main_0_5_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %6 = add nsw i32 %4, %5*/
...
always @(*) begin
	...
	/*   %6 = add nsw i32 %4, %5*/
	if ((cur_state == LEGUP_F_main_BB__0_4)) begin
		main_signed_add_32_1_op1 = main_0_5;
	end
	/* main: %0*/
	/*   %12 = add nsw i32 %10, %11*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_5)) */ begin
		main_signed_add_32_1_op1 = main_0_11_reg;
	end
end
always @(*) begin
