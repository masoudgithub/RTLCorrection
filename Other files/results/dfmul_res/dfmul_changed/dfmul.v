...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__126_46)) begin
		main_normalizeFloat64Subnormalexit9i_94_reg <= main_126_20i;
		if (start == 1'b0 && ^(main_126_20i) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_normalizeFloat64Subnormalexit9i_94_reg"); $finish; end
	end
	/* main: %float64_mul.exit*/
	/*   %211 = add nsw i32 %210, %main_result.02*/
	if ((cur_state == LEGUP_F_main_BB_float64_mulexit_61)) begin
		main_normalizeFloat64Subnormalexit9i_94_reg <= main_float64_mulexit_211;
		if (start == 1'b0 && ^(main_float64_mulexit_211) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_normalizeFloat64Subnormalexit9i_94_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %normalizeFloat64Subnormal.exit9.i*/
...
/* main: %126*/
/*   %141 = add i64 %140, %138*/
	main_126_141_reg = main_thread6ii_194_reg;
end
always @(*) begin
...
/* main: %126*/
/*   %148 = add i64 %147, %145*/
	main_126_148_reg = main_thread6ii_194_reg;
end
always @(*) begin
	/* main: %126*/
...
/* main: %126*/
/*   %.20.i = add i32 %129, %.20.v.i*/
	main_126_20i_reg = main_normalizeFloat64Subnormalexit9i_94_reg;
end
always @(*) begin
	/* main: %126*/
...
always @(*) begin
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
		main_164_165 = main_signed_add_64_0;
end
always @(*) begin
/* main: %164*/
/*   %165 = add i64 512, %..i*/
...
always @(*) begin
	...
	/*   %194 = add i64 %zSig57.i.i, 512*/
		main_thread6ii_194 = main_signed_add_64_0;
end
always @(posedge clk) begin
	/* main: %.thread6.i.i*/
	/*   %194 = add i64 %zSig57.i.i, 512*/
	...
	/*   %141 = add i64 %140, %138*/
	if ((cur_state == LEGUP_F_main_BB__126_43)) begin
		main_thread6ii_194_reg <= main_126_141;
		if (start == 1'b0 && ^(main_126_141) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_thread6ii_194_reg"); $finish; end
	end
	/* main: %126*/
	/*   %148 = add i64 %147, %145*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_thread6ii_194_reg <= main_126_148;
		if (start == 1'b0 && ^(main_126_148) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_thread6ii_194_reg"); $finish; end
	end
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
	if ((cur_state == LEGUP_F_main_BB__164_49)) begin
...
always @(*) begin
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
		main_thread6ii_206 = main_signed_add_64_1;
end
always @(posedge clk) begin
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
...
/* main: %float64_mul.exit*/
/*   %211 = add nsw i32 %210, %main_result.02*/
	main_float64_mulexit_211_reg = main_normalizeFloat64Subnormalexit9i_94_reg;
end
always @(*) begin
	/* main: %float64_mul.exit*/
...
always @(*) begin
	...
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
	else if ((cur_state == LEGUP_F_main_BB__164_49)) begin
...
always @(*) begin
	...
	/*   %165 = add i64 512, %..i*/
		...
		main_signed_add_64_0_op1 = main_126_i_reg;
	end
	/* main: %.thread6.i.i*/
	/*   %194 = add i64 %zSig57.i.i, 512*/
	else /* if ((cur_state == LEGUP_F_main_BB_thread6ii_58)) */ begin
...
always @(*) begin
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
		main_signed_add_64_1_op0 = main_thread6ii_204;
end
always @(*) begin
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
		main_signed_add_64_1_op1 = main_thread6ii_205;
end
always @(*) begin
