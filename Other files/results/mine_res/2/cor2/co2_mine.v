...
parameter [3:0] LEGUP_F_main_BB__15_6 = 4'd6;
parameter [3:0] LEGUP_F_main_BB__17_7 = 4'd7;
parameter [3:0] LEGUP_F_main_BB__19_8 = 4'd8;
...
always @(posedge clk)
	...
	/* main: %0*/
	/*   %13 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %12) #2*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		$write("Result: %d\n", $signed(main_0_12));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_0_12) === 1'bX) finish <= 0;
	end
	/* main: %15*/
	/*   %16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__15_6)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %17*/
	/*   %18 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__17_7)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__0_5:
	if ((main_0_14 == 1'd1))
		next_state = LEGUP_F_main_BB__15_6;
	else if ((main_0_14 == 1'd0))
		next_state = LEGUP_F_main_BB__17_7;
LEGUP_F_main_BB__15_6:
		next_state = LEGUP_F_main_BB__19_8;
LEGUP_F_main_BB__17_7:
		next_state = LEGUP_F_main_BB__19_8;
...
always @(*) begin
	main_0_11 = main_signed_multiply_32_1;
end
always @(*) begin
	/* main: %0*/
...
always @(*) begin
	/* main: %0*/
	/*   %14 = icmp eq i32 %12, 30*/
		main_0_14 = (main_0_12 == 32'd30);
end
always @(*) begin
	/* main: %0*/
	/*   %4 = mul nsw i32 %1, %2*/
...
always @(*) begin
	...
	/*   %12 = add nsw i32 %10, %11*/
		...
		main_signed_add_32_1_op0 = main_0_10;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %5 = add nsw i32 %4, %3*/
	if ((cur_state == LEGUP_F_main_BB__0_4)) begin
		main_signed_add_32_1_op1 = main_0_3;
	end
	/* main: %0*/
	/*   %12 = add nsw i32 %10, %11*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_5)) */ begin
...
always @(*) begin
	/* main: %0*/
	/*   %6 = add nsw i32 %5, %1*/
		main_signed_add_32_0_op0 = main_0_5;
end
always @(*) begin
	/* main: %0*/
	/*   %6 = add nsw i32 %5, %1*/
...
always @(posedge clk) begin
	...
	/*   ret i32 %12*/
	if ((cur_state == LEGUP_F_main_BB__19_8)) begin
		return_val <= main_0_12_reg;
		if (start == 1'b0 && ^(main_0_12_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); /*$finish;*/ end
	end
end
