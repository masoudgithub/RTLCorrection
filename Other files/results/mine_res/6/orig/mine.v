...
parameter [3:0] LEGUP_F_main_BB__13_6 = 4'd6;
parameter [3:0] LEGUP_F_main_BB__15_7 = 4'd7;
parameter [3:0] LEGUP_F_main_BB__17_8 = 4'd8;
...
reg  lpm_mult_main_0_6_en;
reg [31:0] main_0_6_stage0_reg;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		...
		if (reset == 1'b0 && ^(main_0_10) === 1'bX) finish <= 0;
	end
	/* main: %13*/
	...
	if ((cur_state == LEGUP_F_main_BB__15_7)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__0_5:
	...
	else if ((main_0_12 == 1'd0))
		next_state = LEGUP_F_main_BB__15_7;
LEGUP_F_main_BB__13_6:
		next_state = LEGUP_F_main_BB__17_8;
LEGUP_F_main_BB__15_7:
		next_state = LEGUP_F_main_BB__17_8;
LEGUP_F_main_BB__17_8:
		next_state = LEGUP_0;
default:
	next_state = cur_state;
endcase
...
always @(*) begin
	/* main: %0*/
	/*   %4 = add nsw i32 %3, %1*/
		main_0_4 = main_signed_add_32_0;
end
always @(*) begin
	/* main: %0*/
	/*   %5 = add nsw i32 %4, %2*/
		main_0_5 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %5 = add nsw i32 %4, %2*/
...
always @(*) begin
	main_0_6 = main_signed_multiply_32_0;
end
always @(*) begin
	main_0_7 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %0*/
	/*   %8 = sub nsw i32 %5, %7*/
		main_0_8 = main_signed_subtract_32_0;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %10 = sub nsw i32 %8, %9*/
		main_0_10 = main_signed_subtract_32_1;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %10 = sub nsw i32 %8, %9*/
...
always @(*) begin
	...
	/*   %12 = icmp eq i32 %10, 30*/
		main_0_12 = (main_0_10 == 32'd30);
end
always @(*) begin
	/* main: %0*/
	/*   %4 = add nsw i32 %3, %1*/
		main_signed_add_32_0_op0 = main_0_3;
end
always @(*) begin
	/* main: %0*/
	/*   %4 = add nsw i32 %3, %1*/
		main_signed_add_32_0_op1 = main_0_1_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %5 = add nsw i32 %4, %2*/
		main_signed_add_32_1_op0 = main_0_4;
end
always @(*) begin
	/* main: %0*/
	/*   %5 = add nsw i32 %4, %2*/
		main_signed_add_32_1_op1 = main_0_2_reg;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %7 = mul nsw i32 %6, %3*/
		...
		main_signed_multiply_32_0_op0 = main_0_6;
	end
end
always @(*) begin
	/* main: %0*/
...
always @(*) begin
	lpm_mult_main_0_6_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %6 = mul nsw i32 %1, %2*/
	if ((lpm_mult_main_0_6_en == 1'd1)) begin
		main_0_6_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main_0_6_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %8 = sub nsw i32 %5, %7*/
		main_signed_subtract_32_0_op0 = main_0_5_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %8 = sub nsw i32 %5, %7*/
		main_signed_subtract_32_0_op1 = main_0_7;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %2, %2*/
		main_signed_multiply_32_1_op0 = main_0_2;
end
always @(*) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %2, %2*/
...
always @(*) begin
	/* main: %0*/
	/*   %10 = sub nsw i32 %8, %9*/
		main_signed_subtract_32_1_op0 = main_0_8;
end
always @(*) begin
	/* main: %0*/
	/*   %10 = sub nsw i32 %8, %9*/
		main_signed_subtract_32_1_op1 = main_0_9_reg;
end
always @(*) begin
...
always @(posedge clk) begin
	...
	/* main: %17*/
	/*   ret i32 %10*/
	if ((cur_state == LEGUP_F_main_BB__17_8)) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %10*/
	if ((cur_state == LEGUP_F_main_BB__17_8)) begin
		return_val <= main_0_10_reg;
		if (start == 1'b0 && ^(main_0_10_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); /*$finish;*/ end
	end
end
