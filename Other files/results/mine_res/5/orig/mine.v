...
parameter [3:0] LEGUP_F_main_BB__11_6 = 4'd6;
parameter [3:0] LEGUP_F_main_BB__13_7 = 4'd7;
parameter [3:0] LEGUP_F_main_BB__15_8 = 4'd8;
...
LEGUP_F_main_BB__0_5:
	if ((main_0_10 == 1'd1))
		next_state = LEGUP_F_main_BB__11_6;
	else if ((main_0_10 == 1'd0))
		next_state = LEGUP_F_main_BB__13_7;
LEGUP_F_main_BB__11_6:
		next_state = LEGUP_F_main_BB__15_8;
LEGUP_F_main_BB__13_7:
		next_state = LEGUP_F_main_BB__15_8;
LEGUP_F_main_BB__15_8:
		next_state = LEGUP_0;
default:
	next_state = cur_state;
endcase
...
always @(posedge clk) begin
	...
	/* main: %15*/
	/*   ret i32 %8*/
	if ((cur_state == LEGUP_F_main_BB__15_8)) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %8*/
	if ((cur_state == LEGUP_F_main_BB__15_8)) begin
		return_val <= main_0_8_reg;
		if (start == 1'b0 && ^(main_0_8_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
