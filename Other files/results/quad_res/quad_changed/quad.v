...
always @(*) begin
	main_0_10 = main_signed_multiply_32_4;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %15 = add nsw i32 %12, %14*/
		main_0_15 = main_signed_add_32_1;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %17 = add nsw i32 %15, %16*/
		main_0_17 = main_signed_add_32_2;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %19 = add nsw i32 %17, %18*/
		main_0_19 = main_signed_add_32_3;
end
always @(*) begin
	main_0_20 = main_signed_multiply_32_2;
end
always @(*) begin
	main_0_21 = main_signed_multiply_32_4;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_0_22 = main_signed_add_32_4;
end
always @(*) begin
	main_0_23 = main_signed_multiply_32_4;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
...
always @(*) begin
	...
	/*   %24 = add nsw i32 %22, %23*/
		main_0_24 = main_signed_add_32_5;
end
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_0_25 = main_signed_add_32_6;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %19 = add nsw i32 %17, %18*/
		main_signed_add_32_3_op0 = main_0_17;
end
always @(*) begin
	/* main: %0*/
	/*   %19 = add nsw i32 %17, %18*/
		main_signed_add_32_3_op1 = main_0_18_reg;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_4_op0 = main_0_1_reg;
	end
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_4_op0 = main_0_2_reg;
	end
	/* main: %0*/
	/*   %21 = mul nsw i32 %20, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_4_op0 = main_0_20;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_4_op1 = main_0_6;
	end
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_4_op1 = main_0_7;
	end
	/* main: %0*/
	/*   %21 = mul nsw i32 %20, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_4_op1 = main_0_7_reg;
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_0_21_en == 1'd1)) begin
		main_0_21_stage0_reg <= (main_signed_multiply_32_4_op0 * main_signed_multiply_32_4_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_4 = main_0_21_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_signed_add_32_4_op0 = main_0_19;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_signed_add_32_4_op1 = main_0_21;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %24 = add nsw i32 %22, %23*/
		main_signed_add_32_5_op0 = main_0_22;
end
always @(*) begin
	/* main: %0*/
	/*   %24 = add nsw i32 %22, %23*/
		main_signed_add_32_5_op1 = main_0_23_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_signed_add_32_6_op0 = main_0_24;
end
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_signed_add_32_6_op1 = main_0_2_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %8, %6*/
		main_signed_multiply_32_1_op1 = main_0_6_reg;
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_0_9_en == 1'd1)) begin
		main_0_9_stage0_reg <= (main_signed_multiply_32_1_op0 * main_signed_multiply_32_1_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_1 = main_0_9_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %26 = mul nsw i32 %3, %4*/
...
always @(*) begin
	...
	/*   %12 = add nsw i32 %9, %11*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		main_signed_add_32_0_op0 = main_0_9_reg;
	end
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
...
always @(*) begin
	...
	/*   %12 = add nsw i32 %9, %11*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		main_signed_add_32_0_op1 = main_0_11;
	end
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_9)) */ begin
...
always @(*) begin
	/* main: %0*/
	/*   %15 = add nsw i32 %12, %14*/
		main_signed_add_32_1_op1 = main_0_14_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %17 = add nsw i32 %15, %16*/
		main_signed_add_32_2_op0 = main_0_15;
end
always @(*) begin
	/* main: %0*/
	/*   %17 = add nsw i32 %15, %16*/
		main_signed_add_32_2_op1 = main_0_16_reg;
end
always @(*) begin
