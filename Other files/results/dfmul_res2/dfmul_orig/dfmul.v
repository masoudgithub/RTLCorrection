...
reg  lpm_mult_main_126_141_en;
reg [63:0] main_126_141_stage0_reg;
...
always @(*) begin
	main_126_141 = main_signed_multiply_64_1;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %141 = mul i64 %137, %138*/
...
always @(*) begin
	main_126_142 = main_signed_multiply_64_2;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %142 = mul i64 %139, %134*/
...
always @(*) begin
	...
	/*   %overflow_intrinsic = zext i64 %141 to i65*/
		main_126_overflow_intrinsic = main_126_141;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %overflow_intrinsic = zext i64 %141 to i65*/
...
always @(*) begin
	...
	/*   %overflow_intrinsic1 = zext i64 %142 to i65*/
		main_126_overflow_intrinsic1 = main_126_142;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %overflow_intrinsic1 = zext i64 %142 to i65*/
...
always @(*) begin
	...
	/*   %overflow_intrinsic2 = add i65 %overflow_intrinsic, %overflow_intrinsic1*/
		main_126_overflow_intrinsic2 = (main_126_overflow_intrinsic + main_126_overflow_intrinsic1);
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %overflow_intrinsic2 = add i65 %overflow_intrinsic, %overflow_intrinsic1*/
...
always @(*) begin
	...
	/*   %144 = zext i1 %overflow_intrinsic_carry to i64*/
		main_126_144 = main_126_overflow_intrinsic_carry;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %144 = zext i1 %overflow_intrinsic_carry to i64*/
...
always @(*) begin
	...
	/*   %145 = shl nuw nsw i64 %144, 32*/
		main_126_145 = (main_126_144 <<< (64'd32 % 64'd64));
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %145 = shl nuw nsw i64 %144, 32*/
...
always @(*) begin
	...
	/*   %146 = lshr i64 %overflow_intrinsic_sum, 32*/
		main_126_146 = (main_126_overflow_intrinsic_sum >>> (64'd32 % 64'd64));
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %146 = lshr i64 %overflow_intrinsic_sum, 32*/
...
always @(*) begin
	/* main: %126*/
	/*   %147 = or i64 %145, %146*/
		main_126_147 = (main_126_145_reg | main_126_146_reg);
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %147 = or i64 %145, %146*/
...
always @(*) begin
	...
	/*   %148 = shl i64 %overflow_intrinsic_sum, 32*/
		main_126_148 = (main_126_overflow_intrinsic_sum <<< (64'd32 % 64'd64));
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %148 = shl i64 %overflow_intrinsic_sum, 32*/
...
always @(*) begin
	...
	/*   %overflow_intrinsic4 = zext i64 %140 to i65*/
		main_126_overflow_intrinsic4 = main_126_140;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %overflow_intrinsic4 = zext i64 %140 to i65*/
...
always @(*) begin
	...
	/*   %overflow_intrinsic5 = zext i64 %148 to i65*/
		main_126_overflow_intrinsic5 = main_126_148;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %overflow_intrinsic5 = zext i64 %148 to i65*/
...
always @(*) begin
	...
	/*   %149 = zext i1 %overflow_intrinsic_carry9 to i64*/
		main_126_149 = main_126_overflow_intrinsic_carry9;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %149 = zext i1 %overflow_intrinsic_carry9 to i64*/
...
always @(*) begin
	/* main: %126*/
	/*   %150 = add i64 %149, %143*/
		main_126_150 = main_signed_add_64_0;
end
always @(*) begin
/* main: %126*/
/*   %150 = add i64 %149, %143*/
	main_126_150_reg = main_thread6ii_194_reg;
end
always @(*) begin
	/* main: %126*/
	/*   %151 = add i64 %150, %147*/
		main_126_151 = main_signed_add_64_1;
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %151 = add i64 %150, %147*/
	...
	if ((cur_state == LEGUP_F_main_BB_thread6ii_58)) begin
		main_126_151_reg <= main_thread6ii_206;
		if (start == 1'b0 && ^(main_thread6ii_206) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_126_151_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %126*/
...
always @(*) begin
	...
	/*   %159 = icmp ugt i32 %158, 2044*/
		main_126_159 = (main_126_158_reg > 32'd2044);
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %159 = icmp ugt i32 %158, 2044*/
...
always @(posedge clk) begin
	...
	/*   %150 = add i64 %149, %143*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_thread6ii_194_reg <= main_126_150;
		if (start == 1'b0 && ^(main_126_150) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_thread6ii_194_reg"); $finish; end
	end
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
	if ((cur_state == LEGUP_F_main_BB__164_49)) begin
...
/* main: %.thread6.i.i*/
/*   %206 = add i64 %204, %205*/
	main_thread6ii_206_reg = main_126_151_reg;
end
always @(*) begin
	/* main: %float64_mul.exit*/
...
always @(*) begin
	...
	/*   %150 = add i64 %149, %143*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_signed_add_64_0_op0 = main_126_149_reg;
	end
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
...
always @(*) begin
	...
	/*   %150 = add i64 %149, %143*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_signed_add_64_0_op1 = main_126_143_reg;
	end
	/* main: %164*/
	/*   %165 = add i64 512, %..i*/
	else if ((cur_state == LEGUP_F_main_BB__164_49)) begin
...
always @(*) begin
	/* main: %126*/
	/*   %141 = mul i64 %137, %138*/
		main_signed_multiply_64_1_op0 = main_126_137;
end
always @(*) begin
	/* main: %126*/
	/*   %141 = mul i64 %137, %138*/
...
always @(*) begin
	lpm_mult_main_126_141_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %126*/
	/*   %141 = mul i64 %137, %138*/
	if ((lpm_mult_main_126_141_en == 1'd1)) begin
		main_126_141_stage0_reg <= (main_signed_multiply_64_1_op0 * main_signed_multiply_64_1_op1);
	end
end
always @(*) begin
	main_signed_multiply_64_1 = main_126_141_stage0_reg;
end
always @(*) begin
	/* main: %126*/
	/*   %142 = mul i64 %139, %134*/
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_126_142_en == 1'd1)) begin
		main_126_142_stage0_reg <= (main_signed_multiply_64_2_op0 * main_signed_multiply_64_2_op1);
	end
end
always @(*) begin
	main_signed_multiply_64_2 = main_126_142_stage0_reg;
end
always @(*) begin
	/* main: %126*/
	/*   %143 = mul i64 %137, %134*/
...
always @(*) begin
	...
	/*   %151 = add i64 %150, %147*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_signed_add_64_1_op0 = main_126_150;
	end
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
	else /* if ((cur_state == LEGUP_F_main_BB_thread6ii_58)) */ begin
...
always @(*) begin
	...
	/*   %151 = add i64 %150, %147*/
	if ((cur_state == LEGUP_F_main_BB__126_45)) begin
		main_signed_add_64_1_op1 = main_126_147_reg;
	end
	/* main: %.thread6.i.i*/
	/*   %206 = add i64 %204, %205*/
	else /* if ((cur_state == LEGUP_F_main_BB_thread6ii_58)) */ begin
