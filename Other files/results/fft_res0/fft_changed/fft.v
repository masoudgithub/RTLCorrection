...
always @(*) begin
	...
	/*   %432 = add nuw nsw i32 %425, %429*/
		main_404_432 = main_signed_add_32_251;
end
always @(*) begin
	/* main: %404*/
	/*   %433 = add nuw nsw i32 %432, %431*/
		main_404_433 = main_signed_add_32_249;
end
always @(*) begin
	/* main: %404*/
	/*   %434 = add nuw nsw i32 %433, %427*/
		main_404_434 = main_signed_add_32_250;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	/* main: %404*/
	/*   %446 = add i32 %445, %440*/
		main_404_446 = main_signed_add_32_251;
end
always @(*) begin
	/* main: %404*/
	/*   %447 = sub i32 %443, %444*/
...
always @(*) begin
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
		main_404_450 = main_signed_add_32_250;
end
always @(*) begin
	/* main: %404*/
	/*   %451 = shl i32 %450, 16*/
...
always @(*) begin
	...
	/*   %452 = add nsw i32 %449, %438*/
		main_404_452 = main_signed_add_32_243;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %457 = add nsw i32 %456, %sext5.i*/
		main_404_457 = main_signed_add_32_244;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %459 = add nsw i32 %455, %449*/
		main_404_459 = main_signed_add_32_245;
end
always @(*) begin
	/* main: %404*/
	/*   %460 = add nsw i32 %459, %sext5.i*/
		main_404_460 = main_signed_add_32_246;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %462 = add nsw i32 %455, %438*/
		main_404_462 = main_signed_add_32_247;
end
always @(*) begin
	/* main: %404*/
	/*   %463 = add nsw i32 %462, %449*/
		main_404_463 = main_signed_add_32_248;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %465 = add nsw i32 %405, %392*/
		main_404_465 = main_signed_add_32_251;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %476 = sub nsw i32 0, %474*/
		main_fftexit_476 = main_signed_subtract_32_0;
end
always @(*) begin
	/* main: %fft.exit*/
...
always @(*) begin
	...
	/*   %485 = add nsw i32 %478, %484*/
		main_fftexit_485 = main_signed_add_32_251;
end
always @(*) begin
	/* main: %fft.exit*/
...
always @(*) begin
	...
	/*   %432 = add nuw nsw i32 %425, %429*/
		...
		main_signed_add_32_251_op0 = main_404_425;
	end
	/* main: %404*/
	/*   %446 = add i32 %445, %440*/
	else if ((cur_state == LEGUP_F_main_BB__404_410)) begin
		main_signed_add_32_251_op0 = main_404_445;
	end
	/* main: %fft.exit*/
	/*   %gep535 = add i32 %gep_int533, %gep_array534*/
	...
	/*   %485 = add nsw i32 %478, %484*/
		...
		main_signed_add_32_251_op0 = main_fftexit_478;
	end
end
always @(*) begin
	/* main: %1*/
	...
	/*   %465 = add nsw i32 %405, %392*/
		...
		main_signed_add_32_251_op1 = main_lrph17i_392_reg;
	end
	/* main: %404*/
	/*   %gep529 = add i32 %gep_int527, %gep_array528*/
	else if ((cur_state == LEGUP_F_main_BB__404_405)) begin
	...
	/*   %432 = add nuw nsw i32 %425, %429*/
		...
		main_signed_add_32_251_op1 = main_404_429;
	end
	/* main: %404*/
	/*   %446 = add i32 %445, %440*/
	else if ((cur_state == LEGUP_F_main_BB__404_410)) begin
		main_signed_add_32_251_op1 = main_404_440;
	end
	/* main: %fft.exit*/
	/*   %gep535 = add i32 %gep_int533, %gep_array534*/
	else if ((cur_state == LEGUP_F_main_BB_fftexit_418)) begin
	...
	/*   %485 = add nsw i32 %478, %484*/
		...
		main_signed_add_32_251_op1 = main_fftexit_484;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %476 = sub nsw i32 0, %474*/
		...
		main_signed_subtract_32_0_op1 = main_fftexit_474;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %433 = add nuw nsw i32 %432, %431*/
		...
		main_signed_add_32_249_op0 = main_404_432;
	end
	/* main: %404*/
	/*   %448 = add i32 %447, %440*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %433 = add nuw nsw i32 %432, %431*/
		...
		main_signed_add_32_249_op1 = main_404_431;
	end
	/* main: %404*/
	/*   %448 = add i32 %447, %440*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %434 = add nuw nsw i32 %433, %427*/
		...
		main_signed_add_32_250_op0 = main_404_433;
	end
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_250_op0 = main_404_446;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %434 = add nuw nsw i32 %433, %427*/
		...
		main_signed_add_32_250_op1 = main_404_427;
	end
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_250_op1 = main_404_438_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %452 = add nsw i32 %449, %438*/
		...
		main_signed_add_32_243_op0 = main_404_449;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %452 = add nsw i32 %449, %438*/
		...
		main_signed_add_32_243_op1 = main_404_438_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %457 = add nsw i32 %456, %sext5.i*/
		...
		main_signed_add_32_244_op0 = main_404_456;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %457 = add nsw i32 %456, %sext5.i*/
		...
		main_signed_add_32_244_op1 = main_404_sext5i;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %459 = add nsw i32 %455, %449*/
		...
		main_signed_add_32_245_op0 = main_404_455;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %459 = add nsw i32 %455, %449*/
		...
		main_signed_add_32_245_op1 = main_404_449;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %460 = add nsw i32 %459, %sext5.i*/
		...
		main_signed_add_32_246_op0 = main_404_459;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %460 = add nsw i32 %459, %sext5.i*/
		...
		main_signed_add_32_246_op1 = main_404_sext5i;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %462 = add nsw i32 %455, %438*/
		...
		main_signed_add_32_247_op0 = main_404_455;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %462 = add nsw i32 %455, %438*/
		...
		main_signed_add_32_247_op1 = main_404_438_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %463 = add nsw i32 %462, %449*/
		...
		main_signed_add_32_248_op0 = main_404_462;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %463 = add nsw i32 %462, %449*/
		...
		main_signed_add_32_248_op1 = main_404_449;
	end
end
always @(*) begin
