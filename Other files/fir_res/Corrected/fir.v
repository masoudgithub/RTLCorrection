...
always @(*) begin
	...
	/*   %indvar.next5 = add i32 %indvar4, 1*/
		main_2_indvarnext5 = main_signed_add_32_2;
end
always @(posedge clk) begin
	/* main: %2*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
...
always @(*) begin
	/* main: %19*/
	/*   %i.01 = add i32 %indvar, 1*/
		main_19_i01 = main_signed_add_32_2;
end
always @(*) begin
/* main: %19*/
/*   %i.01 = add i32 %indvar, 1*/
...
always @(*) begin
	...
	/*   %39 = add nsw i32 %j.02.i, 1*/
		main_preheaderi_39 = main_signed_add_32_0;
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
	/*   %39 = add nsw i32 %j.02.i, 1*/
...
always @(*) begin
	...
	/*   %40 = add i32 %i.01, %temp.01.i*/
		main_preheaderi_40 = main_signed_add_32_2;
end
always @(*) begin
/* main: %.preheader.i*/
/*   %40 = add i32 %i.01, %temp.01.i*/
...
always @(*) begin
	...
	/*   %42 = add i32 %.0.i, %total.03*/
		main_FIRFilterStreamingexit_42 = main_signed_add_32_4;
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %42 = add i32 %.0.i, %total.03*/
...
always @(*) begin
	...
	/*   %indvar.next = add i32 %indvar, 1*/
		main_FIRFilterStreamingexit_indvarnext = main_signed_add_32_2;
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next = add i32 %indvar, 1*/
...
always @(*) begin
	...
	/*   %indvar.next5 = add i32 %indvar4, 1*/
	if ((cur_state == LEGUP_F_main_BB__2_3)) begin
		main_signed_add_32_2_op0 = main_1_indvar4_reg;
	end
	/* main: %19*/
	/*   %i.01 = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__19_6)) begin
		main_signed_add_32_2_op0 = main_19_indvar_reg;
	end
	/* main: %.preheader.i*/
	/*   %40 = add i32 %i.01, %temp.01.i*/
	else if ((cur_state == LEGUP_F_main_BB_preheaderi_16)) begin
		main_signed_add_32_2_op0 = main_19_i01_reg;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next = add i32 %indvar, 1*/
...
always @(*) begin
	...
	/*   %40 = add i32 %i.01, %temp.01.i*/
		...
		main_signed_add_32_2_op1 = main_preheaderi_temp01i_reg;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_22)) */ begin
...
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %42 = add i32 %.0.i, %total.03*/
		main_signed_add_32_4_op0 = main_FIRFilterStreamingexit_0i_reg;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %42 = add i32 %.0.i, %total.03*/
		main_signed_add_32_4_op1 = main_19_total03_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %.preheader.i*/
	/*   %39 = add nsw i32 %j.02.i, 1*/
if (reset) begin main_signed_add_32_0_op1 = 0; end
