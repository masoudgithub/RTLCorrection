...
; <label>:19                                      ; preds = %FIRFilterStreaming.exit, %legup_memset_4.exit
  ...
  %total.03 = phi i32 [ %42, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]
...
.preheader.i:                                     ; preds = %.preheader.i, %.preheader.i.preheader
  %j.02.i = phi i32 [ %39, %.preheader.i ], [ 0, %.preheader.i.preheader ]
  ...
  %39 = add nsw i32 %j.02.i, 1
  %exitcond1 = icmp eq i32 %39, 16
  %40 = add i32 %i.01, %temp.01.i
  %41 = add i32 %40, %38
...
FIRFilterStreaming.exit:                          ; preds = %FIRFilterStreaming.exit.loopexit, %19
  %.0.i = phi i32 [ 0, %19 ], [ %41, %FIRFilterStreaming.exit.loopexit ]
  %42 = add i32 %.0.i, %total.03
  %indvar.next = add i32 %indvar, 1
  %exitcond3 = icmp eq i32 %indvar.next, 32
  br i1 %exitcond3, label %43, label %19

; <label>:43                                      ; preds = %FIRFilterStreaming.exit
  %44 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %42) #1
  %45 = icmp eq i32 %42, 44880
