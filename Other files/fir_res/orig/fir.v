...
parameter [4:0] LEGUP_F_main_BB__42_23 = 5'd23;
parameter [4:0] LEGUP_F_main_BB__45_24 = 5'd24;
parameter [4:0] LEGUP_F_main_BB__47_25 = 5'd25;
parameter [4:0] LEGUP_F_main_BB__49_26 = 5'd26;
...
reg [31:0] main_FIRFilterStreamingexit_41;
reg [31:0] main_FIRFilterStreamingexit_41_reg;
...
always @(posedge clk)
	...
	if ((cur_state == LEGUP_F_main_BB__42_23)) begin
		$write("Result: %d\n", $signed(main_FIRFilterStreamingexit_41_reg));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_FIRFilterStreamingexit_41_reg) === 1'bX) finish <= 0;
	end
	/* main: %45*/
	/*   %46 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__45_24)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %47*/
	/*   %48 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__47_25)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__42_23:
	if ((main_42_44 == 1'd1))
		next_state = LEGUP_F_main_BB__45_24;
	else if ((main_42_44 == 1'd0))
		next_state = LEGUP_F_main_BB__47_25;
LEGUP_F_main_BB__45_24:
		next_state = LEGUP_F_main_BB__49_26;
LEGUP_F_main_BB__47_25:
		next_state = LEGUP_F_main_BB__49_26;
LEGUP_F_main_BB__49_26:
		next_state = LEGUP_0;
...
always @(*) begin
	...
	/*   %total.02 = phi i32 [ %41, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
		...
		main_19_total02 = main_FIRFilterStreamingexit_41;
	end
end
always @(posedge clk) begin
	/* main: %19*/
...
always @(*) begin
	...
	/*   %j.02.i = phi i32 [ %40, %.preheader.i ], [ 0, %.preheader.i.preheader ]*/
		...
		main_preheaderi_j02i = main_preheaderi_40_reg;
	end
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
...
always @(*) begin
	...
	/*   %temp.01.i = phi i32 [ %39, %.preheader.i ], [ 0, %.preheader.i.preheader ]*/
		...
		main_preheaderi_temp01i = main_preheaderi_39;
	end
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
...
always @(*) begin
	...
	/*   %40 = add nsw i32 %j.02.i, 1*/
		main_preheaderi_40 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
	/*   %40 = add nsw i32 %j.02.i, 1*/
...
always @(*) begin
	...
	/*   %exitcond1 = icmp eq i32 %40, 16*/
		main_preheaderi_exitcond1 = (main_preheaderi_40 == 32'd16);
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
	/*   %exitcond1 = icmp eq i32 %40, 16*/
...
always @(*) begin
	...
	/*   %.0.i = phi i32 [ 0, %19 ], [ %39, %FIRFilterStreaming.exit.loopexit ]*/
		...
		main_FIRFilterStreamingexit_0i = main_preheaderi_39_reg;
	end
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	...
	/*   %41 = add i32 %.0.i, %total.02*/
		main_FIRFilterStreamingexit_41 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_22)) begin
		main_FIRFilterStreamingexit_41_reg <= main_FIRFilterStreamingexit_41;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_41) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_FIRFilterStreamingexit_41_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	...
	/*   %44 = icmp eq i32 %41, 44880*/
		main_42_44 = (main_FIRFilterStreamingexit_41_reg == 32'd44880);
end
always @(*) begin
	/* main: %2*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
...
always @(*) begin
	...
	/*   %39 = add nsw i32 %38, %temp.01.i*/
		...
		main_signed_add_32_1_op0 = main_preheaderi_38;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
	else /* if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_22)) */ begin
...
always @(*) begin
	...
	/*   %39 = add nsw i32 %38, %temp.01.i*/
		...
		main_signed_add_32_1_op1 = main_preheaderi_temp01i_reg;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
	else /* if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_22)) */ begin
		main_signed_add_32_1_op1 = main_19_total02_reg;
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	/* main: %49*/
	/*   ret i32 %41*/
	if ((cur_state == LEGUP_F_main_BB__49_26)) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %41*/
	if ((cur_state == LEGUP_F_main_BB__49_26)) begin
		return_val <= main_FIRFilterStreamingexit_41_reg;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_41_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
