...
always @(*) begin
	...
	/*   %39 = add nsw i32 %38, %temp.01.i*/
		main_preheaderi_39 = main_signed_add_32_2;
end
always @(posedge clk) begin
	/* main: %.preheader.i*/
	/*   %39 = add nsw i32 %38, %temp.01.i*/
...
always @(*) begin
	...
	/*   %41 = add i32 %.0.i, %total.02*/
		main_FIRFilterStreamingexit_41 = main_signed_add_32_3;
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
...
always @(*) begin
	/* main: %.preheader.i*/
	/*   %39 = add nsw i32 %38, %temp.01.i*/
		main_signed_add_32_2_op0 = main_preheaderi_38;
end
always @(*) begin
	/* main: %.preheader.i*/
	/*   %39 = add nsw i32 %38, %temp.01.i*/
...
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
		main_signed_add_32_3_op0 = main_FIRFilterStreamingexit_0i_reg;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %41 = add i32 %.0.i, %total.02*/
		main_signed_add_32_3_op1 = main_19_total02_reg;
end
always @(*) begin
