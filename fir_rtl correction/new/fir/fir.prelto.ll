...
; <label>:45                                      ; preds = %FIRFilterStreaming.exit
  ...
  %46 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %.lcssa1) #1
  %47 = icmp eq i32 %.lcssa1, 44880
  br i1 %47, label %48, label %50

; <label>:48                                      ; preds = %45
  %49 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1
  br label %52

; <label>:50                                      ; preds = %45
  %51 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1
  br label %52
...
declare void @legup_memset_4(i8*, i8, i32)
