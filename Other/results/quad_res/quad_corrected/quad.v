...
// @inData = internal global [7 x i32] [i32 10, i32 10, i32 10, i32 10, i32 10, i32 10, i32 10], align 4
...
reg [2:0] inData_address_a;
reg [2:0] inData_address_b;
...
defparam inData.widthad_a = 3;
defparam inData.widthad_b = 3;
defparam inData.width_be_a = 1;
defparam inData.width_be_b = 1;
defparam inData.numwords_a = 7;
defparam inData.numwords_b = 7;
...
always @(*)
begin
	inData_address_a = memory_controller_address_a [3-1+2:2] & {3{select_inData_a}};
...
always @(*)
begin
	inData_address_b = memory_controller_address_b [3-1+2:2] & {3{select_inData_b}};
...
parameter [3:0] LEGUP_F_main_BB__0_6 = 4'd6;
parameter [3:0] LEGUP_F_main_BB__0_7 = 4'd7;
parameter [3:0] LEGUP_F_main_BB__0_8 = 4'd8;
parameter [3:0] LEGUP_F_main_BB__0_9 = 4'd9;
parameter [3:0] LEGUP_F_main_BB__31_10 = 4'd10;
parameter [3:0] LEGUP_F_main_BB__33_11 = 4'd11;
parameter [3:0] LEGUP_F_main_BB__35_12 = 4'd12;
...
reg [31:0] main_0_22;
reg [31:0] main_0_23;
reg [31:0] main_0_23_reg;
reg [31:0] main_0_24;
reg [31:0] main_0_25;
reg [31:0] main_0_26;
reg [31:0] main_0_26_reg;
reg [31:0] main_0_27;
reg [31:0] main_0_27_reg;
reg [31:0] main_0_28;
reg [31:0] main_0_28_reg;
reg  main_0_30;
...
reg  lpm_mult_main_0_9_en;
reg [31:0] main_0_9_stage0_reg;
...
reg  lpm_mult_main_0_16_en;
reg [31:0] main_0_16_stage0_reg;
...
always @(posedge clk)
	...
	/* main: %0*/
	/*   %29 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %28) #2*/
	if ((cur_state == LEGUP_F_main_BB__0_9)) begin
		$write("Result: %d\n", $signed(main_0_28));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_0_28) === 1'bX) finish <= 0;
	end
	/* main: %31*/
	/*   %32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__31_10)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %33*/
	/*   %34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__33_11)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__0_9:
	...
	else if ((main_0_30 == 1'd0))
		next_state = LEGUP_F_main_BB__33_11;
LEGUP_F_main_BB__31_10:
		next_state = LEGUP_F_main_BB__35_12;
LEGUP_F_main_BB__33_11:
		next_state = LEGUP_F_main_BB__35_12;
...
always @(*) begin
	/* main: %0*/
	/*   %1 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 0), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %2 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 1), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %3 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 2), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %4 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 3), align 4*/
		main_0_4 = memory_controller_out_b[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %4 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 3), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %5 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 4), align 4*/
		main_0_5 = memory_controller_out_a[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %5 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 4), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %6 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 5), align 4*/
		main_0_6 = memory_controller_out_b[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %6 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 5), align 4*/
...
always @(*) begin
	/* main: %0*/
	/*   %7 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 6), align 4*/
		main_0_7 = memory_controller_out_a[31:0];
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %7 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 6), align 4*/
...
always @(*) begin
	main_0_8 = main_signed_multiply_32_0;
end
always @(*) begin
	main_0_9 = main_signed_multiply_32_4;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %8, %6*/
...
always @(*) begin
	main_0_10 = main_signed_multiply_32_1;
end
always @(*) begin
	main_0_11 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %0*/
	/*   %12 = add nsw i32 %9, %11*/
		main_0_12 = main_signed_add_32_1;
end
always @(*) begin
	main_0_13 = main_signed_multiply_32_2;
end
always @(*) begin
	main_0_14 = main_signed_multiply_32_0;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
...
always @(*) begin
	...
	/*   %15 = add nsw i32 %12, %14*/
		main_0_15 = main_signed_add_32_2;
end
always @(*) begin
	main_0_16 = main_signed_multiply_32_3;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %16 = mul nsw i32 %4, %6*/
...
always @(*) begin
	...
	/*   %17 = add nsw i32 %15, %16*/
		main_0_17 = main_signed_add_32_3;
end
always @(*) begin
	main_0_18 = main_signed_multiply_32_3;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %18 = mul nsw i32 %5, %7*/
...
always @(*) begin
	...
	/*   %19 = add nsw i32 %17, %18*/
		main_0_19 = main_signed_add_32_0;
end
always @(*) begin
	main_0_20 = main_signed_multiply_32_2;
end
always @(*) begin
	main_0_21 = main_signed_multiply_32_1;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_0_22 = main_signed_add_32_5;
end
always @(*) begin
	main_0_23 = main_signed_multiply_32_1;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		...
		if (start == 1'b0 && ^(main_0_23) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_0_23_reg"); $finish; end
	end
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_6)) begin
...
always @(*) begin
	...
	/*   %24 = add nsw i32 %22, %23*/
		main_0_24 = main_signed_add_32_6;
end
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_0_25 = main_signed_add_32_4;
end
always @(*) begin
	main_0_26 = main_signed_multiply_32_0;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %26 = mul nsw i32 %3, %4*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		...
		if (start == 1'b0 && ^(main_0_26) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_0_26_reg"); $finish; end
	end
	/* main: %0*/
	/*   %26 = mul nsw i32 %3, %4*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
...
always @(*) begin
	...
	/*   %27 = add nsw i32 %25, %26*/
		main_0_27 = main_signed_add_32_7;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %27 = add nsw i32 %25, %26*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		...
		if (start == 1'b0 && ^(main_0_27) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_0_27_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
		main_0_28 = main_signed_add_32_0;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
	if ((cur_state == LEGUP_F_main_BB__0_9)) begin
		...
		if (start == 1'b0 && ^(main_0_28) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_0_28_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %0*/
	/*   %30 = icmp eq i32 %28, 3200*/
		main_0_30 = (main_0_28 == 32'd3200);
end
always @(*) begin
	/* main: %0*/
	/*   %19 = add nsw i32 %17, %18*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		main_signed_add_32_0_op0 = main_0_17;
	end
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_9)) */ begin
		main_signed_add_32_0_op0 = main_0_27_reg;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %19 = add nsw i32 %17, %18*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		main_signed_add_32_0_op1 = main_0_18_reg;
	end
	/* main: %0*/
	/*   %28 = add nsw i32 %27, %5*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_9)) */ begin
		main_signed_add_32_0_op1 = main_0_5_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %13 = mul nsw i32 %3, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_2_op0 = main_0_3_reg;
	end
	/* main: %0*/
	/*   %20 = mul nsw i32 %1, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
		main_signed_multiply_32_2_op0 = main_0_1_reg;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %13 = mul nsw i32 %3, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_2_op1 = main_0_6;
	end
	/* main: %0*/
	/*   %20 = mul nsw i32 %1, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
		main_signed_multiply_32_2_op1 = main_0_7;
	end
end
always @(*) begin
	lpm_mult_main_0_20_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %20 = mul nsw i32 %1, %7*/
	if ((lpm_mult_main_0_20_en == 1'd1)) begin
		main_0_20_stage0_reg <= (main_signed_multiply_32_2_op0 * main_signed_multiply_32_2_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_2 = main_0_20_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_1_op0 = main_0_1_reg;
	end
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_1_op0 = main_0_2_reg;
	end
	/* main: %0*/
	/*   %21 = mul nsw i32 %20, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_1_op0 = main_0_20;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %23 = mul nsw i32 %1, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_1_op1 = main_0_6;
	end
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_1_op1 = main_0_7;
	end
	/* main: %0*/
	/*   %21 = mul nsw i32 %20, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_1_op1 = main_0_7_reg;
	end
end
always @(*) begin
	lpm_mult_main_0_21_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %21 = mul nsw i32 %20, %7*/
	if ((lpm_mult_main_0_21_en == 1'd1)) begin
		main_0_21_stage0_reg <= (main_signed_multiply_32_1_op0 * main_signed_multiply_32_1_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_1 = main_0_21_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_signed_add_32_5_op0 = main_0_19;
end
always @(*) begin
	/* main: %0*/
	/*   %22 = add nsw i32 %19, %21*/
		main_signed_add_32_5_op1 = main_0_21;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %24 = add nsw i32 %22, %23*/
		main_signed_add_32_6_op0 = main_0_22;
end
always @(*) begin
	/* main: %0*/
	/*   %24 = add nsw i32 %22, %23*/
		main_signed_add_32_6_op1 = main_0_23_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_signed_add_32_4_op0 = main_0_24;
end
always @(*) begin
	/* main: %0*/
	/*   %25 = add nsw i32 %24, %2*/
		main_signed_add_32_4_op1 = main_0_2_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %8, %6*/
		main_signed_multiply_32_4_op0 = main_0_8;
end
always @(*) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %8, %6*/
		main_signed_multiply_32_4_op1 = main_0_6_reg;
end
always @(*) begin
	lpm_mult_main_0_9_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %9 = mul nsw i32 %8, %6*/
	if ((lpm_mult_main_0_9_en == 1'd1)) begin
		main_0_9_stage0_reg <= (main_signed_multiply_32_4_op0 * main_signed_multiply_32_4_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_4 = main_0_9_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %26 = mul nsw i32 %3, %4*/
	...
	/*   %8 = mul nsw i32 %1, %6*/
		...
		main_signed_multiply_32_0_op0 = main_0_1_reg;
	end
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_0_op0 = main_0_13;
	end
	/* main: %0*/
	/*   %11 = mul nsw i32 %10, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_0_op0 = main_0_10;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %26 = mul nsw i32 %3, %4*/
	if ((cur_state == LEGUP_F_main_BB__0_4)) begin
		main_signed_multiply_32_0_op1 = main_0_4;
	end
	/* main: %0*/
	/*   %8 = mul nsw i32 %1, %6*/
	else if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_0_op1 = main_0_6;
	end
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
	else if ((cur_state == LEGUP_F_main_BB__0_6)) begin
		main_signed_multiply_32_0_op1 = main_0_7;
	end
	/* main: %0*/
	/*   %11 = mul nsw i32 %10, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
		main_signed_multiply_32_0_op1 = main_0_7_reg;
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_0_11_en == 1'd1)) begin
		main_0_11_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main_0_11_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %12 = add nsw i32 %9, %11*/
		main_signed_add_32_1_op0 = main_0_9_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %12 = add nsw i32 %9, %11*/
		main_signed_add_32_1_op1 = main_0_11;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %15 = add nsw i32 %12, %14*/
		main_signed_add_32_2_op0 = main_0_12;
end
always @(*) begin
	/* main: %0*/
	/*   %15 = add nsw i32 %12, %14*/
		main_signed_add_32_2_op1 = main_0_14_reg;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %16 = mul nsw i32 %4, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_3_op0 = main_0_4_reg;
	end
	/* main: %0*/
	/*   %18 = mul nsw i32 %5, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
		main_signed_multiply_32_3_op0 = main_0_5_reg;
	end
end
always @(*) begin
	/* main: %0*/
	/*   %16 = mul nsw i32 %4, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_3_op1 = main_0_6;
	end
	/* main: %0*/
	/*   %18 = mul nsw i32 %5, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
		main_signed_multiply_32_3_op1 = main_0_7;
	end
end
always @(*) begin
	lpm_mult_main_0_16_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %16 = mul nsw i32 %4, %6*/
	if ((lpm_mult_main_0_16_en == 1'd1)) begin
		main_0_16_stage0_reg <= (main_signed_multiply_32_3_op0 * main_signed_multiply_32_3_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_3 = main_0_16_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %17 = add nsw i32 %15, %16*/
		main_signed_add_32_3_op0 = main_0_15;
end
always @(*) begin
	/* main: %0*/
	/*   %17 = add nsw i32 %15, %16*/
		main_signed_add_32_3_op1 = main_0_16_reg;
end
always @(*) begin
...
always @(*) begin
	/* main: %0*/
	/*   %27 = add nsw i32 %25, %26*/
		main_signed_add_32_7_op0 = main_0_25;
end
always @(*) begin
	/* main: %0*/
	/*   %27 = add nsw i32 %25, %26*/
		main_signed_add_32_7_op1 = main_0_26_reg;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %5 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 4), align 4*/
	if ((cur_state == LEGUP_F_main_BB__0_3)) begin
		memory_controller_address_a = (`TAG_g_inData_a + (4 * 32'd4));
	end
	/* main: %0*/
	/*   %7 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 6), align 4*/
	if ((cur_state == LEGUP_F_main_BB__0_4)) begin
		memory_controller_address_a = (`TAG_g_inData_a + (4 * 32'd6));
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %4 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 3), align 4*/
	if ((cur_state == LEGUP_F_main_BB__0_2)) begin
		memory_controller_address_b = (`TAG_g_inData_a + (4 * 32'd3));
	end
	/* main: %0*/
	/*   %6 = load i32* getelementptr inbounds ([7 x i32]* @inData, i32 0, i32 5), align 4*/
	if ((cur_state == LEGUP_F_main_BB__0_3)) begin
		memory_controller_address_b = (`TAG_g_inData_a + (4 * 32'd5));
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %28*/
	if ((cur_state == LEGUP_F_main_BB__35_12)) begin
		return_val <= main_0_28_reg;
		if (start == 1'b0 && ^(main_0_28_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
