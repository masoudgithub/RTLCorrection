...
parameter [3:0] LEGUP_F_main_BB__22_9 = 4'd9;
parameter [3:0] LEGUP_F_main_BB__24_10 = 4'd10;
parameter [3:0] LEGUP_F_main_BB__26_11 = 4'd11;
...
reg  lpm_mult_main_0_10_en;
reg [31:0] main_0_10_stage0_reg;
...
reg  lpm_mult_main_0_14_en;
reg [31:0] main_0_14_stage0_reg;
...
reg  lpm_mult_main_0_18_en;
reg [31:0] main_0_18_stage0_reg;
...
always @(posedge clk)
	...
	/* main: %0*/
	/*   %20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %19) #2*/
	if ((cur_state == LEGUP_F_main_BB__0_8)) begin
		$write("Result: %d\n", $signed(main_0_19));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_0_19) === 1'bX) finish <= 0;
	end
	/* main: %22*/
	/*   %23 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__22_9)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %24*/
	/*   %25 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #2*/
	if ((cur_state == LEGUP_F_main_BB__24_10)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB__0_8:
	if ((main_0_21 == 1'd1))
		next_state = LEGUP_F_main_BB__22_9;
	else if ((main_0_21 == 1'd0))
		next_state = LEGUP_F_main_BB__24_10;
LEGUP_F_main_BB__22_9:
		next_state = LEGUP_F_main_BB__26_11;
LEGUP_F_main_BB__24_10:
		next_state = LEGUP_F_main_BB__26_11;
LEGUP_F_main_BB__26_11:
		next_state = LEGUP_0;
default:
	next_state = cur_state;
endcase
...
always @(*) begin
	main_0_14 = main_signed_multiply_32_2;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
...
always @(*) begin
	main_0_16 = main_signed_multiply_32_2;
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %16 = mul nsw i32 %4, %6*/
...
always @(*) begin
	/* main: %0*/
	/*   %21 = icmp eq i32 %19, 3200*/
		main_0_21 = (main_0_19 == 32'd3200);
end
always @(*) begin
	/* main: %0*/
	/*   %19 = add nsw i32 %17, %18*/
...
always @(*) begin
	...
	/*   %9 = mul nsw i32 %8, %6*/
		...
		main_signed_multiply_32_0_op1 = main_0_6_reg;
	end
	/* main: %0*/
	/*   %11 = mul nsw i32 %10, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_7)) */ begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_0_8_en == 1'd1)) begin
		main_0_8_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main_0_8_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %13 = mul nsw i32 %3, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_1_op0 = main_0_3_reg;
	end
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
...
always @(*) begin
	lpm_mult_main_0_10_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %10 = mul nsw i32 %2, %7*/
	if ((lpm_mult_main_0_10_en == 1'd1)) begin
		main_0_10_stage0_reg <= (main_signed_multiply_32_1_op0 * main_signed_multiply_32_1_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_1 = main_0_10_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %12 = add nsw i32 %9, %11*/
...
always @(*) begin
	...
	/*   %16 = mul nsw i32 %4, %6*/
	if ((cur_state == LEGUP_F_main_BB__0_5)) begin
		main_signed_multiply_32_2_op0 = main_0_4_reg;
	end
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
	else /* if ((cur_state == LEGUP_F_main_BB__0_6)) */ begin
		main_signed_multiply_32_2_op0 = main_0_13;
	end
end
always @(*) begin
	/* main: %0*/
...
always @(*) begin
	lpm_mult_main_0_14_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %14 = mul nsw i32 %13, %7*/
	if ((lpm_mult_main_0_14_en == 1'd1)) begin
		main_0_14_stage0_reg <= (main_signed_multiply_32_2_op0 * main_signed_multiply_32_2_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_2 = main_0_14_stage0_reg;
end
always @(*) begin
	/* main: %0*/
	/*   %15 = add nsw i32 %12, %14*/
...
always @(*) begin
	lpm_mult_main_0_18_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %0*/
	/*   %18 = mul nsw i32 %5, %7*/
	if ((lpm_mult_main_0_18_en == 1'd1)) begin
		main_0_18_stage0_reg <= (main_signed_multiply_32_3_op0 * main_signed_multiply_32_3_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_3 = main_0_18_stage0_reg;
end
always @(posedge clk) begin
	...
	/* main: %26*/
	/*   ret i32 %19*/
	if ((cur_state == LEGUP_F_main_BB__26_11)) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %19*/
	if ((cur_state == LEGUP_F_main_BB__26_11)) begin
		return_val <= main_0_19_reg;
		if (start == 1'b0 && ^(main_0_19_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
