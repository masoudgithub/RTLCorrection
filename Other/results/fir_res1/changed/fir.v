...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_tmpi;
		if (start == 1'b0 && ^(main__crit_edgei_tmpi) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %46 = add i32 %indvar, 2*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_crit_edgei_crit_edge_46;
		if (start == 1'b0 && ^(main__crit_edgei_crit_edgei_crit_edge_46) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
	/* main: %19*/
	/*   %i.03 = add i32 %indvar3, 1*/
	if ((cur_state == LEGUP_F_main_BB__19_6)) begin
		main_2_indvarnext7_reg <= main_19_i03;
		if (start == 1'b0 && ^(main_19_i03) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
...
always @(*) begin
	/* main: %19*/
	/*   %i.03 = add i32 %indvar3, 1*/
		main_19_i03 = main_signed_add_32_0;
end
always @(*) begin
/* main: %19*/
/*   %i.03 = add i32 %indvar3, 1*/
	main_19_i03_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %19*/
	/*   %34 = icmp eq i32 %33, 0*/
...
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %46 = add i32 %indvar, 2*/
		main__crit_edgei_crit_edgei_crit_edge_46 = main_signed_add_32_0;
end
always @(*) begin
/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
/*   %46 = add i32 %indvar, 2*/
	main__crit_edgei_crit_edgei_crit_edge_46_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
...
always @(*) begin
	...
	/*   %tmp.i = add i32 %42, %.pre.i*/
		...
		main_signed_add_32_0_op0 = main__crit_edgei_42;
	end
	/* main: %._crit_edge.i*/
	/*   %45 = add i32 %44, %tmp1.i*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_21)) begin
		main_signed_add_32_0_op0 = main__crit_edgei_44_reg;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %46 = add i32 %indvar, 2*/
...
always @(*) begin
	...
	/*   %47 = add i32 %.0.i, %total.04*/
		...
		main_signed_add_32_0_op1 = main_19_total04_reg;
	end
end
always @(*) begin
