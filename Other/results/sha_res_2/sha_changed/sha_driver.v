...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB_memcpyexiti_11)) begin
		main_4_6_reg <= main_memcpyexiti_indvarnext19;
		if (start == 1'b0 && ^(main_memcpyexiti_indvarnext19) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_4_6_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %4*/
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_4_7_reg <= main_28_31;
		if (start == 1'b0 && ^(main_28_31) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_4_7_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %4*/
...
always @(posedge clk) begin
	...
	/*   %32 = add i32 %26, %29*/
	if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_4_8_reg <= main_28_32;
		if (start == 1'b0 && ^(main_28_32) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_4_8_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %4*/
...
always @(*) begin
	/* main: %4*/
	/*   %9 = add i32 %3, %5*/
		main_4_9 = main_signed_add_32_3;
end
always @(*) begin
/* main: %4*/
/*   %9 = add i32 %3, %5*/
	main_4_9_reg = main_28_33_reg;
end
always @(*) begin
	/* main: %4*/
...
always @(*) begin
	...
	/*   %indvar.next15 = add i32 %indvar14, 1*/
		main_4_indvarnext15 = main_signed_add_32_4;
end
always @(posedge clk) begin
	/* main: %4*/
	/*   %indvar.next15 = add i32 %indvar14, 1*/
...
always @(*) begin
	/* main: %memcpy.exit.i*/
	/*   %indvar.next19 = add i32 %indvar18, 1*/
		main_memcpyexiti_indvarnext19 = main_signed_add_32_0;
end
always @(*) begin
/* main: %memcpy.exit.i*/
/*   %indvar.next19 = add i32 %indvar18, 1*/
	main_memcpyexiti_indvarnext19_reg = main_4_6_reg;
end
always @(*) begin
	/* main: %memcpy.exit.i*/
...
always @(*) begin
	/* main: %28*/
	/*   %30 = add i32 %25, %29*/
		main_28_30 = main_signed_add_32_0;
end
always @(*) begin
/* main: %28*/
/*   %30 = add i32 %25, %29*/
	main_28_30_reg = main_memcpyexiti12_indvarnext5_reg;
end
always @(*) begin
	/* main: %28*/
...
always @(*) begin
	/* main: %28*/
	/*   %31 = add i32 %24, %29*/
		main_28_31 = main_signed_add_32_1;
end
always @(*) begin
/* main: %28*/
/*   %31 = add i32 %24, %29*/
	main_28_31_reg = main_4_7_reg;
end
always @(*) begin
	/* main: %28*/
...
always @(*) begin
	/* main: %28*/
	/*   %32 = add i32 %26, %29*/
		main_28_32 = main_signed_add_32_2;
end
always @(*) begin
/* main: %28*/
/*   %32 = add i32 %26, %29*/
	main_28_32_reg = main_4_8_reg;
end
always @(*) begin
	/* main: %28*/
...
always @(*) begin
	/* main: %28*/
	/*   %33 = add i32 %27, %29*/
		main_28_33 = main_signed_add_32_3;
end
always @(posedge clk) begin
	/* main: %28*/
	/*   %33 = add i32 %27, %29*/
	...
	/*   %9 = add i32 %3, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_28_33_reg <= main_4_9;
		if (start == 1'b0 && ^(main_4_9) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_28_33_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %28*/
...
always @(*) begin
	...
	/*   %indvar.next2 = add i32 %indvar1, 1*/
		main_28_indvarnext2 = main_signed_add_32_4;
end
always @(posedge clk) begin
	/* main: %28*/
	/*   %indvar.next2 = add i32 %indvar1, 1*/
...
always @(*) begin
	...
	/*   %indvar.next5 = add i32 %indvar4, 1*/
		main_memcpyexiti12_indvarnext5 = main_signed_add_32_0;
end
always @(posedge clk) begin
	/* main: %memcpy.exit.i12*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
	...
	if ((cur_state == LEGUP_F_main_BB_lrphi8i_26)) begin
		main_memcpyexiti12_indvarnext5_reg <= main_lrphi8i_48;
		if (start == 1'b0 && ^(main_lrphi8i_48) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_memcpyexiti12_indvarnext5_reg"); $finish; end
	end
	/* main: %28*/
	/*   %30 = add i32 %25, %29*/
	if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_memcpyexiti12_indvarnext5_reg <= main_28_30;
		if (start == 1'b0 && ^(main_28_30) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_memcpyexiti12_indvarnext5_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %memcpy.exit.i12*/
...
/* main: %.lr.ph.i8.i*/
/*   %48 = add i32 %indvar, 1*/
	main_lrphi8i_48_reg = main_memcpyexiti12_indvarnext5_reg;
end
always @(*) begin
	/* main: %.lr.ph.i8.i*/
...
always @(*) begin
	...
	/*   %indvar.next = add i32 %indvar, 1*/
		main_lrphi8i_indvarnext = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %.lr.ph.i8.i*/
	/*   %indvar.next = add i32 %indvar, 1*/
...
always @(*) begin
	...
	/*   %50 = load i32* @sha_info_digest.4, align 4, !tbaa !1*/
		main_49_50 = memory_controller_out_a[31:0];
end
always @(posedge clk) begin
	/* main: %49*/
	/*   %50 = load i32* @sha_info_digest.4, align 4, !tbaa !1*/
...
always @(*) begin
	...
	/*   %indvar.next15 = add i32 %indvar14, 1*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_4_op0 = main_4_indvar14_reg;
	end
	/* main: %28*/
	/*   %indvar.next2 = add i32 %indvar1, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB__28_16)) */ begin
		main_signed_add_32_4_op0 = main_28_indvar1_reg;
	end
end
always @(*) begin
	/* main: %4*/
...
always @(*) begin
	...
	/*   %6 = add i32 %1, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_0_op0 = main_preheaderi_1_reg;
	end
	/* main: %memcpy.exit.i*/
	/*   %indvar.next19 = add i32 %indvar18, 1*/
	else if ((cur_state == LEGUP_F_main_BB_memcpyexiti_11)) begin
		main_signed_add_32_0_op0 = main_preheaderi_indvar18_reg;
	end
	/* main: %28*/
	/*   %30 = add i32 %25, %29*/
	else if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_signed_add_32_0_op0 = main_preheaderi8_25_reg;
	end
	/* main: %memcpy.exit.i12*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
	else if ((cur_state == LEGUP_F_main_BB_memcpyexiti12_21)) begin
		main_signed_add_32_0_op0 = main_preheaderi8_indvar4_reg;
	end
	/* main: %.lr.ph.i8.i*/
	/*   %48 = add i32 %indvar, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB_lrphi8i_26)) */ begin
		main_signed_add_32_0_op0 = main_lrphi8i_indvar_reg;
	end
end
always @(*) begin
	/* main: %4*/
	/*   %6 = add i32 %1, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_0_op1 = main_4_5;
	end
	/* main: %memcpy.exit.i*/
	/*   %indvar.next19 = add i32 %indvar18, 1*/
	else if ((cur_state == LEGUP_F_main_BB_memcpyexiti_11)) begin
	...
	/*   %30 = add i32 %25, %29*/
		...
		main_signed_add_32_0_op1 = main_28_29;
	end
	/* main: %memcpy.exit.i12*/
	/*   %indvar.next5 = add i32 %indvar4, 1*/
	else if ((cur_state == LEGUP_F_main_BB_memcpyexiti12_21)) begin
...
always @(*) begin
	...
	/*   %7 = add i32 %0, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_1_op0 = main_preheaderi_0_reg;
	end
	/* main: %28*/
	/*   %31 = add i32 %24, %29*/
	else if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_signed_add_32_1_op0 = main_preheaderi8_24_reg;
	end
	/* main: %.lr.ph.i8.i*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB_lrphi8i_26)) */ begin
		main_signed_add_32_1_op0 = main_lrphi8i_indvar_reg;
	end
end
always @(*) begin
	/* main: %4*/
	/*   %7 = add i32 %0, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_1_op1 = main_4_5;
	end
	/* main: %28*/
	/*   %31 = add i32 %24, %29*/
	else if ((cur_state == LEGUP_F_main_BB__28_16)) begin
		main_signed_add_32_1_op1 = main_28_29;
	end
	/* main: %.lr.ph.i8.i*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB_lrphi8i_26)) */ begin
...
always @(*) begin
	...
	/*   %8 = add i32 %2, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_2_op0 = main_preheaderi_2_reg;
	end
	/* main: %28*/
	/*   %32 = add i32 %26, %29*/
	else /* if ((cur_state == LEGUP_F_main_BB__28_16)) */ begin
		main_signed_add_32_2_op0 = main_preheaderi8_26_reg;
	end
end
always @(*) begin
	/* main: %4*/
	/*   %8 = add i32 %2, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_2_op1 = main_4_5;
	end
	/* main: %28*/
	/*   %32 = add i32 %26, %29*/
	else /* if ((cur_state == LEGUP_F_main_BB__28_16)) */ begin
		main_signed_add_32_2_op1 = main_28_29;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %9 = add i32 %3, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_3_op0 = main_preheaderi_3_reg;
	end
	/* main: %28*/
	/*   %33 = add i32 %27, %29*/
	else /* if ((cur_state == LEGUP_F_main_BB__28_16)) */ begin
		main_signed_add_32_3_op0 = main_preheaderi8_27_reg;
	end
end
always @(*) begin
	/* main: %4*/
	/*   %9 = add i32 %3, %5*/
	if ((cur_state == LEGUP_F_main_BB__4_6)) begin
		main_signed_add_32_3_op1 = main_4_5;
	end
	/* main: %28*/
	/*   %33 = add i32 %27, %29*/
	else /* if ((cur_state == LEGUP_F_main_BB__28_16)) */ begin
		main_signed_add_32_3_op1 = main_28_29;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   store i32 %47, i32* %p1.02.i.i10, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__28_19)) begin
		memory_controller_address_a = main_28_p102ii10_reg;
	end
	/* main: %.lr.ph.i8.preheader.i*/
	/*   store i32 128, i32* getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_lrphi8preheaderi_24)) begin
...
always @(*) begin
	...
	/*   store i32 %47, i32* %p1.02.i.i10, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__28_19)) begin
		memory_controller_in_a = main_28_47;
	end
	/* main: %.lr.ph.i8.preheader.i*/
	/*   store i32 128, i32* getelementptr inbounds ([16 x i32]* @sha_info_data, i32 0, i32 0), align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB_lrphi8preheaderi_24)) begin
