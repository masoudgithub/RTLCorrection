...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_1_indvarsivnext5_reg <= main_6_gep505;
		if (start == 1'b0 && ^(main_6_gep505) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_1_indvarsivnext5_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %1*/
...
always @(*) begin
	...
	/*   %gep9 = add i32 %gep_int8, 64*/
		main_6_gep9 = main_signed_add_32_248;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	...
	/*   %gep15 = add i32 %gep_int14, 2*/
		main_6_gep15 = main_signed_add_32_249;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	...
	/*   %gep17 = add i32 %gep_int16, 32*/
		main_6_gep17 = main_signed_add_32_250;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	/* main: %6*/
	/*   %gep505 = add i32 %gep_int504, 126*/
		main_6_gep505 = main_signed_add_32_0;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	...
	/*   %gep507 = add i32 %gep_int506, 126*/
		main_6_gep507 = main_signed_add_32_3;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	...
	/*   %gep509 = add i32 %gep_int508, 126*/
		main_6_gep509 = main_signed_add_32_4;
end
always @(*) begin
	/* main: %6*/
...
always @(*) begin
	...
	/*   %433 = add nuw nsw i32 %432, %431*/
		main_404_433 = main_signed_add_32_2;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
		main_404_450 = main_signed_add_32_2;
end
always @(*) begin
	/* main: %404*/
	/*   %451 = shl i32 %450, 16*/
...
always @(*) begin
	...
	/*   %459 = add nsw i32 %455, %449*/
		main_404_459 = main_signed_add_32_3;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %462 = add nsw i32 %455, %438*/
		main_404_462 = main_signed_add_32_4;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %gep505 = add i32 %gep_int504, 126*/
		...
		main_signed_add_32_0_op0 = main_6_gep_int504;
	end
	/* main: %.lr.ph.i*/
	/*   %397 = add nsw i32 %394, 1*/
...
always @(*) begin
	...
	/*   %gep505 = add i32 %gep_int504, 126*/
		...
		main_signed_add_32_0_op1 = 32'd126;
	end
	/* main: %.lr.ph.i*/
	/*   %397 = add nsw i32 %394, 1*/
	else if ((cur_state == LEGUP_F_main_BB_lrphi_399)) begin
...
always @(*) begin
	...
	/*   %gep15 = add i32 %gep_int14, 2*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_249_op0 = main_6_gep_int14;
	end
	/* main: %404*/
	/*   %448 = add i32 %447, %440*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %gep15 = add i32 %gep_int14, 2*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_249_op1 = 32'd2;
	end
	/* main: %404*/
	/*   %448 = add i32 %447, %440*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %gep17 = add i32 %gep_int16, 32*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_250_op0 = main_6_gep_int16;
	end
	/* main: %404*/
	/*   %457 = add nsw i32 %456, %sext5.i*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %gep17 = add i32 %gep_int16, 32*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_250_op1 = 32'd32;
	end
	/* main: %404*/
	/*   %457 = add nsw i32 %456, %sext5.i*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	/* main: %6*/
	/*   %gep9 = add i32 %gep_int8, 64*/
		main_signed_add_32_248_op0 = main_6_gep_int8;
end
always @(*) begin
	/* main: %6*/
	/*   %gep9 = add i32 %gep_int8, 64*/
if (reset) begin main_signed_add_32_248_op1 = 0; end
		main_signed_add_32_248_op1 = 32'd64;
end
always @(*) begin
...
always @(*) begin
	...
	/*   %433 = add nuw nsw i32 %432, %431*/
		...
		main_signed_add_32_2_op0 = main_404_432;
	end
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_2_op0 = main_404_446;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %433 = add nuw nsw i32 %432, %431*/
		...
		main_signed_add_32_2_op1 = main_404_431;
	end
	/* main: %404*/
	/*   %450 = add i32 %446, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_2_op1 = main_404_438_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %gep507 = add i32 %gep_int506, 126*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_3_op0 = main_6_gep_int506;
	end
	/* main: %404*/
	/*   %459 = add nsw i32 %455, %449*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
...
always @(*) begin
	...
	/*   %gep507 = add i32 %gep_int506, 126*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_3_op1 = 32'd126;
	end
	/* main: %404*/
	/*   %459 = add nsw i32 %455, %449*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_3_op1 = main_404_449;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %gep509 = add i32 %gep_int508, 126*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_4_op0 = main_6_gep_int508;
	end
	/* main: %404*/
	/*   %462 = add nsw i32 %455, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
		main_signed_add_32_4_op0 = main_404_455;
	end
end
always @(*) begin
	/* main: %6*/
	/*   %gep509 = add i32 %gep_int508, 126*/
	if ((cur_state == LEGUP_F_main_BB__6_11)) begin
		main_signed_add_32_4_op1 = 32'd126;
	end
	/* main: %404*/
	/*   %462 = add nsw i32 %455, %438*/
	else /* if ((cur_state == LEGUP_F_main_BB__404_410)) */ begin
