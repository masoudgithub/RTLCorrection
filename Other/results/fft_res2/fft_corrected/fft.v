...
always @(*) begin
	...
	/*   %415 = add nuw nsw i32 %414, %412*/
		main_404_415 = main_signed_add_32_12;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %424 = add nuw nsw i32 %423, %421*/
		main_404_424 = main_signed_add_32_13;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %430 = add nuw nsw i32 %429, %427*/
		main_404_430 = main_signed_add_32_14;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %436 = add nuw nsw i32 %435, %433*/
		main_404_436 = main_signed_add_32_15;
end
always @(*) begin
	/* main: %404*/
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_414)) begin
		main_404_446_reg <= main__crit_edgei_451;
		if (start == 1'b0 && ^(main__crit_edgei_451) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_404_446_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	...
	/*   %448 = add nsw i32 %405, %392*/
		main_404_448 = main_signed_add_32_7;
end
always @(*) begin
	/* main: %404*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %451 = add i16 %m.04.i, 1*/
		main__crit_edgei_451 = main_signed_add_16_1;
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	...
	/*   %gep532 = add i32 %gep_int530, %gep_array531*/
		main_fftexit_gep532 = main_signed_add_32_17;
end
always @(*) begin
	/* main: %fft.exit*/
...
always @(*) begin
	...
	/*   %461 = add nsw i32 %460, %sum.02*/
		main_fftexit_461 = main_signed_add_32_19;
end
always @(*) begin
	/* main: %fft.exit*/
...
always @(*) begin
	...
	/*   %gep535 = add i32 %gep_int533, %gep_array534*/
		main_fftexit_gep535 = main_signed_add_32_18;
end
always @(*) begin
	/* main: %fft.exit*/
...
always @(*) begin
	...
	/*   %468 = add nsw i32 %461, %467*/
		main_fftexit_468 = main_signed_add_32_20;
end
always @(*) begin
	/* main: %fft.exit*/
	/*   %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1*/
		main_fftexit_indvarsivnext = main_signed_add_32_16;
end
always @(posedge clk) begin
	/* main: %fft.exit*/
	/*   %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1*/
...
always @(*) begin
	...
	/*   %406 = add nsw i32 %405, %l.08.i*/
		...
		main_signed_add_32_6_op1 = main_preheaderi_l08i_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %461 = add nsw i32 %460, %sum.02*/
		...
		main_signed_add_32_19_op0 = main_fftexit_460;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %461 = add nsw i32 %460, %sum.02*/
		...
		main_signed_add_32_19_op1 = main_fftexit_sum02_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %468 = add nsw i32 %461, %467*/
		...
		main_signed_add_32_20_op0 = main_fftexit_461;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %468 = add nsw i32 %461, %467*/
		...
		main_signed_add_32_20_op1 = main_fftexit_467;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %448 = add nsw i32 %405, %392*/
		...
		main_signed_add_32_7_op1 = main_lrph5i_392_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %424 = add nuw nsw i32 %423, %421*/
		...
		main_signed_add_32_13_op0 = main_404_423;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %424 = add nuw nsw i32 %423, %421*/
		...
		main_signed_add_32_13_op1 = main_404_421;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %430 = add nuw nsw i32 %429, %427*/
		...
		main_signed_add_32_14_op0 = main_404_429;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %430 = add nuw nsw i32 %429, %427*/
		...
		main_signed_add_32_14_op1 = main_404_427;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %436 = add nuw nsw i32 %435, %433*/
		...
		main_signed_add_32_15_op0 = main_404_435;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %436 = add nuw nsw i32 %435, %433*/
		...
		main_signed_add_32_15_op1 = main_404_433;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1*/
		...
		main_signed_add_32_16_op0 = main_fftexit_indvarsiv_reg;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %indvars.iv.next = add nuw nsw i32 %indvars.iv, 1*/
		...
		main_signed_add_32_16_op1 = 32'd1;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %gep532 = add i32 %gep_int530, %gep_array531*/
		...
		main_signed_add_32_17_op0 = main_fftexit_gep_int530_reg;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %gep532 = add i32 %gep_int530, %gep_array531*/
		...
		main_signed_add_32_17_op1 = main_fftexit_gep_array531_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %gep535 = add i32 %gep_int533, %gep_array534*/
		...
		main_signed_add_32_18_op0 = main_fftexit_gep_int533_reg;
	end
end
always @(*) begin
	/* main: %6*/
	...
	/*   %gep535 = add i32 %gep_int533, %gep_array534*/
		...
		main_signed_add_32_18_op1 = main_fftexit_gep_array534_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %451 = add i16 %m.04.i, 1*/
		...
		main_signed_add_16_1_op0 = main_393_m04i_reg;
	end
end
always @(*) begin
	/* main: %404*/
	...
	/*   %451 = add i16 %m.04.i, 1*/
		...
		main_signed_add_16_1_op1 = 16'd1;
	end
end
always @(*) begin
