...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) begin
		main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg <= main_FIRFilterStreamingexit_46;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_46) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg"); /*$finish;*/ end
	end
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %46 = add i32 %.0.i, %total.02*/
		main_FIRFilterStreamingexit_46 = main_signed_add_32_1;
end
always @(*) begin
/* main: %FIRFilterStreaming.exit*/
/*   %46 = add i32 %.0.i, %total.02*/
	main_FIRFilterStreamingexit_46_reg = main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next4 = add i32 %indvar3, 1*/
		main_FIRFilterStreamingexit_indvarnext4 = main_signed_add_32_0;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
