...
parameter [4:0] LEGUP_F_main_BB__47_28 = 5'd28;
parameter [4:0] LEGUP_F_main_BB__50_29 = 5'd29;
parameter [4:0] LEGUP_F_main_BB__52_30 = 5'd30;
parameter [4:0] LEGUP_F_main_BB__54_31 = 5'd31;
...
reg [31:0] main__crit_edgei_crit_edgei_crit_edge_45;
reg [31:0] main__crit_edgei_crit_edgei_crit_edge_45_reg;
...
reg [31:0] main_FIRFilterStreamingexit_46_reg;
...
reg  lpm_mult_main__crit_edgei_43_en;
reg [31:0] main__crit_edgei_43_stage0_reg;
...
always @(posedge clk)
	...
	/* main: %47*/
	/*   %48 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %46) #1*/
	if ((cur_state == LEGUP_F_main_BB__47_28)) begin
		$write("Result: %d\n", $signed(main_FIRFilterStreamingexit_46_reg));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_FIRFilterStreamingexit_46_reg) === 1'bX) finish <= 0;
	end
	/* main: %50*/
	/*   %51 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__50_29)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %52*/
	/*   %53 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__52_30)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB_FIRFilterStreamingexit_27:
	if ((main_FIRFilterStreamingexit_exitcond5 == 1'd1))
		next_state = LEGUP_F_main_BB__47_28;
...
LEGUP_F_main_BB__2_4:
		next_state = LEGUP_F_main_BB__1_2;
LEGUP_F_main_BB__47_28:
	if ((main_47_49 == 1'd1))
		next_state = LEGUP_F_main_BB__50_29;
	else if ((main_47_49 == 1'd0))
		next_state = LEGUP_F_main_BB__52_30;
LEGUP_F_main_BB__50_29:
		next_state = LEGUP_F_main_BB__54_31;
LEGUP_F_main_BB__52_30:
		next_state = LEGUP_F_main_BB__54_31;
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_42;
		if (start == 1'b0 && ^(main__crit_edgei_42) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); /*$finish;*/ end
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %45 = add i32 %indvar, 2*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_crit_edgei_crit_edge_45;
		if (start == 1'b0 && ^(main__crit_edgei_crit_edgei_crit_edge_45) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); /*$finish;*/ end
	end
	/* main: %19*/
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_38;
		if (start == 1'b0 && ^(main__crit_edgei_38) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); /*$finish;*/ end
	end
end
always @(*) begin
...
always @(*) begin
	/* main: %19*/
	/*   %total.02 = phi i32 [ %46, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
	if (((cur_state == LEGUP_F_main_BB_legup_memset_4exit_5) & (memory_controller_waitrequest == 1'd0))) begin
	...
	/*   %total.02 = phi i32 [ %46, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
		...
		main_19_total02 = main_FIRFilterStreamingexit_46;
	end
end
always @(posedge clk) begin
	/* main: %19*/
...
always @(*) begin
	main_preheaderipreheader_36 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %37 = phi i32 [ %44, %._crit_edge.i.._crit_edge.i_crit_edge ], [ %36, %.preheader.i.preheader ]*/
	if (((cur_state == LEGUP_F_main_BB_preheaderipreheader_16) & (memory_controller_waitrequest == 1'd0))) begin
		main__crit_edgei_37 = main_preheaderipreheader_36;
	end
	/* main: %._crit_edge.i*/
	/*   %37 = phi i32 [ %44, %._crit_edge.i.._crit_edge.i_crit_edge ], [ %36, %.preheader.i.preheader ]*/
	else /* if (((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_25) & (memory_controller_waitrequest == 1'd0))) */ begin
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %38 = add i32 %indvar, 1*/
		main__crit_edgei_38 = main_signed_add_32_0;
end
always @(*) begin
/* main: %._crit_edge.i*/
/*   %38 = add i32 %indvar, 1*/
	main__crit_edgei_38_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %scevgep = getelementptr [16 x i32]* @main.coefficients, i32 0, i32 %38*/
		main__crit_edgei_scevgep = (`TAG_g_maincoefficients_a + (4 * main__crit_edgei_38_reg));
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %39 = sub i32 14, %indvar*/
		main__crit_edgei_39 = main_signed_subtract_32_0;
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %39 = sub i32 14, %indvar*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %scevgep2 = getelementptr [16 x i32]* %previous, i32 0, i32 %39*/
		main__crit_edgei_scevgep2 = (`TAG_main_0_previous_a + (4 * main__crit_edgei_39_reg));
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %40 = load i32* %scevgep2, align 4, !tbaa !1*/
		main__crit_edgei_40 = memory_controller_out_a[31:0];
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %41 = load i32* %scevgep, align 4, !tbaa !1*/
		main__crit_edgei_41 = memory_controller_out_b[31:0];
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %42 = add i32 %40, %.pre.i*/
		main__crit_edgei_42 = main_signed_add_32_0;
end
always @(*) begin
	main__crit_edgei_43 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %45 = add i32 %indvar, 2*/
		main__crit_edgei_crit_edgei_crit_edge_45 = main_signed_add_32_0;
end
always @(*) begin
/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
/*   %45 = add i32 %indvar, 2*/
	main__crit_edgei_crit_edgei_crit_edge_45_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %.phi.trans.insert.i.phi.trans.insert = getelementptr [16 x i32]* %previous, i32 0, i32 %45*/
		main__crit_edgei_crit_edgei_crit_edge_phitransinsertiphitransinsert = (`TAG_main_0_previous_a + (4 * main__crit_edgei_crit_edgei_crit_edge_45_reg));
end
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
...
always @(posedge clk) begin
	...
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) begin
		main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg <= main_FIRFilterStreamingexit_indvarnext4;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_indvarnext4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg"); /*$finish;*/ end
	end
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %.0.i = phi i32 [ 0, %19 ], [ %44, %FIRFilterStreaming.exit.loopexit ]*/
	...
	/*   %.0.i = phi i32 [ 0, %19 ], [ %44, %FIRFilterStreaming.exit.loopexit ]*/
		...
		main_FIRFilterStreamingexit_0i = main__crit_edgei_44_reg;
	end
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(posedge clk) begin
	...
	/*   %46 = add i32 %.0.i, %total.02*/
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) begin
		main_FIRFilterStreamingexit_46_reg <= main_FIRFilterStreamingexit_46;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_46) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_FIRFilterStreamingexit_46_reg"); /*$finish;*/ end
	end
	/* main: %.preheader.i.preheader*/
	/*   %35 = add i32 %33, %i.01*/
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_15)) begin
		main_FIRFilterStreamingexit_46_reg <= main_preheaderipreheader_35;
		if (start == 1'b0 && ^(main_preheaderipreheader_35) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_FIRFilterStreamingexit_46_reg"); /*$finish;*/ end
	end
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	/* main: %47*/
	/*   %49 = icmp eq i32 %46, 44880*/
		main_47_49 = (main_FIRFilterStreamingexit_46_reg == 32'd44880);
end
always @(*) begin
	/* main: %2*/
	/*   %indvar.next7 = add i32 %indvar6, 1*/
	...
	/* main: %.preheader.i.preheader*/
	/*   %35 = add i32 %33, %i.01*/
	else if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_15)) begin
		main_signed_add_32_0_op0 = main_19_33_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %38 = add i32 %indvar, 1*/
...
always @(*) begin
	...
	/*   %35 = add i32 %33, %i.01*/
		...
		main_signed_add_32_0_op1 = main_19_i01_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %38 = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
...
always @(*) begin
	...
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_15)) begin
		main_signed_multiply_32_0_op0 = main_preheaderipreheader_35;
	end
	/* main: %._crit_edge.i*/
	/*   %43 = mul nsw i32 %42, %41*/
	else /* if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) */ begin
		main_signed_multiply_32_0_op0 = main__crit_edgei_42;
	end
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	...
	/*   %43 = mul nsw i32 %42, %41*/
		...
		main_signed_multiply_32_0_op1 = main__crit_edgei_41;
	end
end
always @(*) begin
	lpm_mult_main__crit_edgei_43_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %43 = mul nsw i32 %42, %41*/
	if ((lpm_mult_main__crit_edgei_43_en == 1'd1)) begin
		main__crit_edgei_43_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main__crit_edgei_43_stage0_reg;
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %44 = add nsw i32 %43, %37*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_21)) begin
		main_signed_add_32_1_op0 = main__crit_edgei_43;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
...
always @(*) begin
	...
	/*   %44 = add nsw i32 %43, %37*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_21)) begin
		main_signed_add_32_1_op1 = main__crit_edgei_37_reg;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
...
always @(posedge clk) begin
	...
	/* main: %54*/
	/*   ret i32 %46*/
	if ((cur_state == LEGUP_F_main_BB__54_31)) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %46*/
	if ((cur_state == LEGUP_F_main_BB__54_31)) begin
		return_val <= main_FIRFilterStreamingexit_46_reg;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_46_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); /*$finish;*/ end
	end
end
