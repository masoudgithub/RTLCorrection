...
parameter [4:0] LEGUP_F_main_BB__50_28 = 5'd28;
parameter [4:0] LEGUP_F_main_BB__53_29 = 5'd29;
parameter [4:0] LEGUP_F_main_BB__55_30 = 5'd30;
parameter [4:0] LEGUP_F_main_BB__57_31 = 5'd31;
...
reg [31:0] main_19_total02;
reg [31:0] main_19_total02_reg;
...
reg [31:0] main__crit_edgei_46;
reg [31:0] main__crit_edgei_46_reg;
reg [31:0] main__crit_edgei_47;
reg [31:0] main__crit_edgei_47_reg;
reg  main__crit_edgei_exitcond1;
reg  main__crit_edgei_exitcond1_reg;
reg [31:0] main__crit_edgei_crit_edgei_crit_edge_48;
reg [31:0] main__crit_edgei_crit_edgei_crit_edge_48_reg;
...
reg [31:0] main_FIRFilterStreamingexit_49;
reg [31:0] main_FIRFilterStreamingexit_49_reg;
...
reg  lpm_mult_main__crit_edgei_45_en;
reg [31:0] main__crit_edgei_45_stage0_reg;
...
always @(posedge clk)
	...
	/* main: %50*/
	/*   %51 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([12 x i8]* @.str, i32 0, i32 0), i32 %49) #1*/
	if ((cur_state == LEGUP_F_main_BB__50_28)) begin
		$write("Result: %d\n", $signed(main_FIRFilterStreamingexit_49_reg));
		// to fix quartus warning
		if (reset == 1'b0 && ^(main_FIRFilterStreamingexit_49_reg) === 1'bX) finish <= 0;
	end
	/* main: %53*/
	/*   %54 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str1, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__53_29)) begin
		$write("RESULT: PASS\n");
	end
	/* main: %55*/
	/*   %56 = tail call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([14 x i8]* @.str2, i32 0, i32 0)) #1*/
	if ((cur_state == LEGUP_F_main_BB__55_30)) begin
		$write("RESULT: FAIL\n");
	end
end
...
LEGUP_F_main_BB_FIRFilterStreamingexit_27:
	if ((main_FIRFilterStreamingexit_exitcond5 == 1'd1))
		next_state = LEGUP_F_main_BB__50_28;
...
LEGUP_F_main_BB__2_4:
		next_state = LEGUP_F_main_BB__1_2;
LEGUP_F_main_BB__50_28:
	if ((main_50_52 == 1'd1))
		next_state = LEGUP_F_main_BB__53_29;
	else if ((main_50_52 == 1'd0))
		next_state = LEGUP_F_main_BB__55_30;
LEGUP_F_main_BB__53_29:
		next_state = LEGUP_F_main_BB__57_31;
LEGUP_F_main_BB__55_30:
		next_state = LEGUP_F_main_BB__57_31;
LEGUP_F_main_BB__57_31:
		next_state = LEGUP_0;
...
always @(*) begin
	...
	/*   %indvar.next7 = add i32 %indvar6, 1*/
		main_2_indvarnext7 = main_signed_add_32_0;
end
always @(posedge clk) begin
	/* main: %2*/
	/*   %indvar.next7 = add i32 %indvar6, 1*/
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_crit_edgei_crit_edge_48;
		if (start == 1'b0 && ^(main__crit_edgei_crit_edgei_crit_edge_48) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
	/* main: %19*/
	/*   %i.01 = add i32 %indvar3, 1*/
	if ((cur_state == LEGUP_F_main_BB__19_6)) begin
		main_2_indvarnext7_reg <= main_19_i01;
		if (start == 1'b0 && ^(main_19_i01) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
	/* main: %.preheader.i.preheader*/
	/*   %36 = add i32 %35, 11*/
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_16)) begin
		main_2_indvarnext7_reg <= main_preheaderipreheader_36;
		if (start == 1'b0 && ^(main_preheaderipreheader_36) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
	/* main: %._crit_edge.i*/
	/*   %40 = add i32 %indvar, 1*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
		main_2_indvarnext7_reg <= main__crit_edgei_40;
		if (start == 1'b0 && ^(main__crit_edgei_40) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_2_indvarnext7_reg"); $finish; end
	end
end
always @(*) begin
...
always @(*) begin
	/* main: %19*/
	/*   %total.02 = phi i32 [ %49, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
	if (((cur_state == LEGUP_F_main_BB_legup_memset_4exit_5) & (memory_controller_waitrequest == 1'd0))) begin
		main_19_total02 = 32'd0;
	end
	/* main: %19*/
	/*   %total.02 = phi i32 [ %49, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
	else /* if ((((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27) & (memory_controller_waitrequest == 1'd0)) & (main_FIRFilterStreamingexit_exitcond5 == 1'd0))) */ begin
		main_19_total02 = main_FIRFilterStreamingexit_49;
	end
end
always @(posedge clk) begin
	/* main: %19*/
	/*   %total.02 = phi i32 [ %49, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
	if (((cur_state == LEGUP_F_main_BB_legup_memset_4exit_5) & (memory_controller_waitrequest == 1'd0))) begin
		main_19_total02_reg <= main_19_total02;
		if (start == 1'b0 && ^(main_19_total02) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_19_total02_reg"); $finish; end
	end
	/* main: %19*/
	/*   %total.02 = phi i32 [ %49, %FIRFilterStreaming.exit ], [ 0, %legup_memset_4.exit ]*/
	if ((((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27) & (memory_controller_waitrequest == 1'd0)) & (main_FIRFilterStreamingexit_exitcond5 == 1'd0))) begin
...
/* main: %19*/
/*   %i.01 = add i32 %indvar3, 1*/
	main_19_i01_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %19*/
	/*   %34 = icmp eq i32 %33, 0*/
...
always @(*) begin
	main_preheaderipreheader_35 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %36 = add i32 %35, 11*/
		main_preheaderipreheader_36 = main_signed_add_32_0;
end
always @(*) begin
	main_preheaderipreheader_37 = main_signed_multiply_32_1;
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %38 = add i32 %36, %37*/
		main_preheaderipreheader_38 = main_signed_add_32_1;
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %39 = phi i32 [ %47, %._crit_edge.i.._crit_edge.i_crit_edge ], [ %38, %.preheader.i.preheader ]*/
	if (((cur_state == LEGUP_F_main_BB_preheaderipreheader_16) & (memory_controller_waitrequest == 1'd0))) begin
	...
	/*   %39 = phi i32 [ %47, %._crit_edge.i.._crit_edge.i_crit_edge ], [ %38, %.preheader.i.preheader ]*/
		...
		main__crit_edgei_39 = main__crit_edgei_47_reg;
	end
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %40 = add i32 %indvar, 1*/
		main__crit_edgei_40 = main_signed_add_32_0;
end
always @(*) begin
/* main: %._crit_edge.i*/
/*   %40 = add i32 %indvar, 1*/
	main__crit_edgei_40_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	...
	/*   %41 = sub i32 14, %indvar*/
		main__crit_edgei_41 = main_signed_subtract_32_0;
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %41 = sub i32 14, %indvar*/
...
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %44 = add i32 %42, %.pre.i*/
		main__crit_edgei_44 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %44 = add i32 %42, %.pre.i*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) begin
	...
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main__crit_edgei_44_reg <= main__crit_edgei_crit_edgei_crit_edge_indvarnext;
		if (start == 1'b0 && ^(main__crit_edgei_crit_edgei_crit_edge_indvarnext) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_44_reg"); $finish; end
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next4 = add i32 %indvar3, 1*/
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) begin
		main__crit_edgei_44_reg <= main_FIRFilterStreamingexit_indvarnext4;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_indvarnext4) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_44_reg"); $finish; end
	end
end
always @(*) begin
	main__crit_edgei_45 = main_signed_multiply_32_0;
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %46 = add i32 %39, %.pre.i*/
		main__crit_edgei_46 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %46 = add i32 %39, %.pre.i*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
		main__crit_edgei_46_reg <= main__crit_edgei_46;
		if (start == 1'b0 && ^(main__crit_edgei_46) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_46_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %47 = add i32 %46, %45*/
		main__crit_edgei_47 = main_signed_add_32_1;
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %47 = add i32 %46, %45*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_21)) begin
		main__crit_edgei_47_reg <= main__crit_edgei_47;
		if (start == 1'b0 && ^(main__crit_edgei_47) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main__crit_edgei_47_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %._crit_edge.i*/
...
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %48 = add i32 %indvar, 2*/
		main__crit_edgei_crit_edgei_crit_edge_48 = main_signed_add_32_0;
end
always @(*) begin
/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
/*   %48 = add i32 %indvar, 2*/
	main__crit_edgei_crit_edgei_crit_edge_48_reg = main_2_indvarnext7_reg;
end
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %.phi.trans.insert.i.phi.trans.insert = getelementptr [16 x i32]* %previous, i32 0, i32 %48*/
		main__crit_edgei_crit_edgei_crit_edge_phitransinsertiphitransinsert = (`TAG_main_0_previous_a + (4 * main__crit_edgei_crit_edgei_crit_edge_48_reg));
end
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
...
always @(*) begin
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %indvar.next = add i32 %indvar, 1*/
		main__crit_edgei_crit_edgei_crit_edge_indvarnext = main_signed_add_32_1;
end
always @(*) begin
/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
/*   %indvar.next = add i32 %indvar, 1*/
	main__crit_edgei_crit_edgei_crit_edge_indvarnext_reg = main__crit_edgei_44_reg;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %.0.i = phi i32 [ 0, %19 ], [ %47, %FIRFilterStreaming.exit.loopexit ]*/
	...
	/*   %.0.i = phi i32 [ 0, %19 ], [ %47, %FIRFilterStreaming.exit.loopexit ]*/
		...
		main_FIRFilterStreamingexit_0i = main__crit_edgei_47_reg;
	end
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %49 = add i32 %.0.i, %total.02*/
		main_FIRFilterStreamingexit_49 = main_signed_add_32_0;
end
always @(posedge clk) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %49 = add i32 %.0.i, %total.02*/
	if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) begin
		main_FIRFilterStreamingexit_49_reg <= main_FIRFilterStreamingexit_49;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_49) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to main_FIRFilterStreamingexit_49_reg"); $finish; end
	end
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next4 = add i32 %indvar3, 1*/
		main_FIRFilterStreamingexit_indvarnext4 = main_signed_add_32_1;
end
always @(*) begin
	/* main: %FIRFilterStreaming.exit*/
...
always @(*) begin
	/* main: %50*/
	/*   %52 = icmp eq i32 %49, 44880*/
		main_50_52 = (main_FIRFilterStreamingexit_49_reg == 32'd44880);
end
always @(*) begin
	/* main: %2*/
	/*   %indvar.next7 = add i32 %indvar6, 1*/
	if ((cur_state == LEGUP_F_main_BB__2_3)) begin
		main_signed_add_32_0_op0 = main_1_indvar6_reg;
	end
	/* main: %19*/
	/*   %i.01 = add i32 %indvar3, 1*/
	else if ((cur_state == LEGUP_F_main_BB__19_6)) begin
		main_signed_add_32_0_op0 = main_19_indvar3_reg;
	end
	/* main: %.preheader.i.preheader*/
	/*   %36 = add i32 %35, 11*/
	else if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_16)) begin
		main_signed_add_32_0_op0 = main_preheaderipreheader_35;
	end
	/* main: %._crit_edge.i*/
	/*   %40 = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
		main_signed_add_32_0_op0 = main__crit_edgei_indvar_reg;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %48 = add i32 %indvar, 2*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main_signed_add_32_0_op0 = main__crit_edgei_indvar_reg;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %49 = add i32 %.0.i, %total.02*/
...
always @(*) begin
	...
	/*   %36 = add i32 %35, 11*/
		...
		main_signed_add_32_0_op1 = 32'd11;
	end
	/* main: %._crit_edge.i*/
	/*   %40 = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
	...
	/*   %49 = add i32 %.0.i, %total.02*/
		...
		main_signed_add_32_0_op1 = main_19_total02_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   %38 = add i32 %36, %37*/
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_16)) begin
		main_signed_add_32_1_op0 = main_preheaderipreheader_36;
	end
	/* main: %._crit_edge.i*/
	/*   %46 = add i32 %39, %.pre.i*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
		main_signed_add_32_1_op0 = main__crit_edgei_39_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %44 = add i32 %42, %.pre.i*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) begin
		main_signed_add_32_1_op0 = main__crit_edgei_42;
	end
	/* main: %._crit_edge.i*/
	/*   %47 = add i32 %46, %45*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_21)) begin
		main_signed_add_32_1_op0 = main__crit_edgei_46_reg;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
		main_signed_add_32_1_op0 = main__crit_edgei_indvar_reg;
	end
	/* main: %FIRFilterStreaming.exit*/
	/*   %indvar.next4 = add i32 %indvar3, 1*/
	else /* if ((cur_state == LEGUP_F_main_BB_FIRFilterStreamingexit_27)) */ begin
		main_signed_add_32_1_op0 = main_19_indvar3_reg;
	end
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %38 = add i32 %36, %37*/
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_16)) begin
		main_signed_add_32_1_op1 = main_preheaderipreheader_37;
	end
	/* main: %._crit_edge.i*/
	/*   %46 = add i32 %39, %.pre.i*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_17)) begin
	...
	/*   %47 = add i32 %46, %45*/
		...
		main_signed_add_32_1_op1 = main__crit_edgei_45;
	end
	/* main: %._crit_edge.i.._crit_edge.i_crit_edge*/
	/*   %indvar.next = add i32 %indvar, 1*/
	else if ((cur_state == LEGUP_F_main_BB__crit_edgei_crit_edgei_crit_edge_22)) begin
...
always @(*) begin
	...
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_15)) begin
		main_signed_multiply_32_0_op0 = main_19_indvar3_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %45 = mul nsw i32 %44, %43*/
	else /* if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) */ begin
		main_signed_multiply_32_0_op0 = main__crit_edgei_44;
	end
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %35 = mul i32 %indvar3, 11*/
	if ((cur_state == LEGUP_F_main_BB_preheaderipreheader_15)) begin
		main_signed_multiply_32_0_op1 = 32'd11;
	end
	/* main: %._crit_edge.i*/
	/*   %45 = mul nsw i32 %44, %43*/
	else /* if ((cur_state == LEGUP_F_main_BB__crit_edgei_20)) */ begin
		main_signed_multiply_32_0_op1 = main__crit_edgei_43;
	end
end
always @(*) begin
	lpm_mult_main__crit_edgei_45_en = (memory_controller_waitrequest == 1'd0);
end
always @(posedge clk) begin
	/* main: %._crit_edge.i*/
	/*   %45 = mul nsw i32 %44, %43*/
	if ((lpm_mult_main__crit_edgei_45_en == 1'd1)) begin
		main__crit_edgei_45_stage0_reg <= (main_signed_multiply_32_0_op0 * main_signed_multiply_32_0_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_0 = main__crit_edgei_45_stage0_reg;
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %37 = mul i32 %33, 10*/
		main_signed_multiply_32_1_op0 = main_19_33_reg;
end
always @(*) begin
	/* main: %.preheader.i.preheader*/
	/*   %37 = mul i32 %33, 10*/
if (reset) begin main_signed_multiply_32_1_op1 = 0; end
		main_signed_multiply_32_1_op1 = 32'd10;
end
always @(*) begin
...
always @(posedge clk) begin
	...
	if ((lpm_mult_main_preheaderipreheader_37_en == 1'd1)) begin
		main_preheaderipreheader_37_stage0_reg <= (main_signed_multiply_32_1_op0 * main_signed_multiply_32_1_op1);
	end
end
always @(*) begin
	main_signed_multiply_32_1 = main_preheaderipreheader_37_stage0_reg;
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %41 = sub i32 14, %indvar*/
if (reset) begin main_signed_subtract_32_0_op0 = 0; end
		main_signed_subtract_32_0_op0 = 32'd14;
end
always @(*) begin
	/* main: %._crit_edge.i*/
	/*   %41 = sub i32 14, %indvar*/
		main_signed_subtract_32_0_op1 = main__crit_edgei_indvar_reg;
end
always @(*) begin
...
always @(posedge clk) begin
	...
	/* main: %57*/
	/*   ret i32 %49*/
	if ((cur_state == LEGUP_F_main_BB__57_31)) begin
...
always @(*) begin
	...
	/*   store i32 %i.01, i32* %3, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__19_13)) begin
		memory_controller_address_a = main_legup_memset_4exit_3_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %42 = load i32* %scevgep2, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_18)) begin
...
always @(*) begin
	...
	/*   store i32 %i.01, i32* %3, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__19_13)) begin
		memory_controller_in_a = main_19_i01_reg;
	end
end
always @(*) begin
...
always @(*) begin
	...
	/*   store i32 %indvar3, i32* %18, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__19_13)) begin
		memory_controller_address_b = main_legup_memset_4exit_18_reg;
	end
	/* main: %._crit_edge.i*/
	/*   %43 = load i32* %scevgep, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__crit_edgei_18)) begin
...
always @(*) begin
	...
	/*   store i32 %indvar3, i32* %18, align 4, !tbaa !1*/
	if ((cur_state == LEGUP_F_main_BB__19_13)) begin
		memory_controller_in_b = main_19_indvar3_reg;
	end
end
always @(*) begin
...
always @(posedge clk) begin
	...
	/*   ret i32 %49*/
	if ((cur_state == LEGUP_F_main_BB__57_31)) begin
		return_val <= main_FIRFilterStreamingexit_49_reg;
		if (start == 1'b0 && ^(main_FIRFilterStreamingexit_49_reg) === 1'bX) begin $display ("ERROR: Right hand side is 'X'. Assigned to return_val"); $finish; end
	end
end
